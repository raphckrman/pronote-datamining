...
a("liste.wai.DemarrerNavigation", "Démarrer la navigation dans la liste avec la touche Tabulation");
...
a("liste.wai.DescriptionTri", "Déplacez le(s) tri(s) avec les flèches gauche et droite, changez l'ordre de tri avec touches Entrée ou Barre espace");
...
a("calendrier.WAI.MultiSelec", "Multi-séléction de semaines, naviguez avec les flèches gauche et droite et validez avec les touches Entrée ou Barre espace");
...
a("CentraleNotifications.AucuneNouvelleNotification", "Aucune nouvelle notification");
...
a("AppliMobile.titreFiche", "QR Code d'ajout de compte sur l'application mobile");
a("AppliMobile.ModeOpQrCode", "Pour générer le QR code, permettant l'ajout de votre compte sur l'application mobile %s, vous devez définir un code de vérification");
a("AppliMobile.AccesSiteMobile", "Accès au site mobile depuis un navigateur");
...
a("AppliMobile.MethodeConfig", "Depuis un téléphone, installer l'application %s (disponible sur tous les stores).");
a("AppliMobile.MethodeConfigSuite", "Dans la \"Gestion des comptes\", flashez ce QR Code.");
a("AppliMobile.MethodeConfigFin", "Saisissez votre code de vérification défini précédemment (durée de validité 10min)");
...
a("LienPolitiqueMotDePasse.ConsulterNotrePolitiqueSecuriteMDP", "Renforcer la sécurité et éviter le piratage des comptes");
...
a("DoubleAuth.RenforcerSecurite", "Renforcer la sécurité de votre compte");
a("DoubleAuth.EnSavoirPlus", "En savoir plus");
a("DoubleAuth.LegendeStrategie", "Choisissez le niveau à appliquer pour renforcer la sécurité de votre compte");
a("DoubleAuth.LegendeStrategieCompte", "Niveau de sécurité pour renforcer mon compte parmi ceux proposé(s) par l'établissement :");
a("DoubleAuth.StrategieFort", "Fort");
a("DoubleAuth.StrategieMoyen", "Moyen");
a("DoubleAuth.StrategieAucun", "Aucun");
a("DoubleAuth.LegendeChoixStratTitre", "A chaque connexion sur un nouvel appareil");
...
a("DoubleAuth.MessageCreationCodePIN", "Votre code PIN vous sera demandé à chaque connexion sur un appareil non enregistré");
a("DoubleAuth.EnregistrerSousNom", "Enregistrer sous le nom");
a("DoubleAuth.NbCaracteresMax_D", "%d caractères maximum");
a("DoubleAuth.WAI_SaisiePINEtValider_D", "Vous devez saisir au moins %d caractères à l'aide des boutons, puis valider");
a("DoubleAuth.WAI_SaisiePIN_D", "Vous devez saisir %d caractères à l'aide des boutons");
a("DoubleAuth.WAI_ConfirmPINEtValider", "Vous devez confirmez votre code PIN à l'aide des boutons, puis valider");
a("DoubleAuth.WAI_ConfirmPIN", "Vous devez confirmez votre code PIN à l'aide des boutons");
a("DoubleAuth.WAI_CodeReinitValide", "Le code de réinitialisation est validé.");
...
a("DoubleAuth.NouvelAppareilRenseignerPIN", "Afin de garantir la sécurité de votre compte, vous devez renseigner votre code PIN.");
a("DoubleAuth.ProcedureReInitialisationCodePIN_S", "Ne fermez pas cette fenêtre et renseignez le code de réinitialisation reçu à l'adresse %s, puis définissez un nouveau code PIN");
a("DoubleAuth.WAI_ProcedureReInitialisationCodePIN_DS", "Vous devez saisir le code de réinitialisation de %d caractères reçu à l'adresse %s à l'aide des boutons");
a("DoubleAuth.WAI_ControleCodePINCourant", "Vous devez saisir votre code PIN à l'aide des boutons, puis valider");
a("DoubleAuth.WAI_ControleCodePINCourantFixe", "Vous devez saisir votre code PIN à l'aide des boutons");
...
a("DoubleAuth.ValiderTitreInconnu", "Connexion depuis un appareil non enregistré");
a("DoubleAuth.ValiderInfoPIN", "Votre code est demandé à chaque connexion sur un appareil non enregistré");
...
a("DoubleAuth.EnregistrerAppareilInfoIdentification", "Cet appareil n'a pas encore été enregistré.");
...
a("DoubleAuth.EnregistrerAppareilNommerAppareil", "Il s'agit d'un appareil de confiance");
...
a("DoubleAuth.LienFAQPIN", "Comment éviter la saisie du code PIN à chaque connexion ?");
a("DoubleAuth.LienFAQEnregistrement", "Pourquoi enregistrer les appareils de confiance ?");
...
a("DoubleAuth.PrefChoisirDEnregistrer", "A chaque fois que vous vous connecterez depuis un appareil ou navigateur non enregistré, vous pourrez choisir ou non de l'enregistrer.");
a("DoubleAuth.PrefPensezASupprimer", "Pensez à supprimer les appareils et/ou navigateurs enregistrés que vous n'utilisez plus.");
...
a("DoubleAuth.RenforcerSecuInfoPIN", "Ce code PIN sera demandé à chaque connexion depuis un appareil non enregistré, et une notification sera envoyée");
...
a("fenetreHarcelement.victimeDeHarcelement", "Victime ou témoin de harcèlement ?");
a("fenetreHarcelement.referentsContreHarcelement", "Référent(s) contre le harcèlement au sein de l'établissement %s");
...
a("documentsATelecharger.redeposerLeFichierRempli", "Redéposer le fichier rempli");
...
a("documentsATelecharger.dateLimiteDepassee", "Date limite du dépôt dépassée");
...
a("documentsATelecharger.hintMemo", "Un commentaire est associé à ce document");
...
a("documentsATelecharger.messageSuppression", "Confirmez-vous la suppression du document ?");
a("documentsATelecharger.ConfirmSupprDocCasier", "Confirmez-vous la suppression du document %s de votre casier ?");
...
a("documentsATelecharger.deposeParUnResponsable", "Déposé par un autre responsable le %s");
a("documentsATelecharger.deposeparEtablissement", "Déposé par l'établissement le %s");
a("documentsATelecharger.jusquAu", "Jusqu'au %s");
a("documentsATelecharger.aucunDocumentAdeposer", "Aucun document à déposer");
...
a("LienPolitiqueMotDePasse.UrlFAQMotDePasse", "https://www.index-education.com/redirect.php?produit=pn&page=comment-renforcer-securite&version=2024.3.8.0&distrib=FR&lg=fr&flag=Espace_Parent&type=LienDocProduit");
...
a("accueil.FAST.reserverAnnulerService", "Réserver, annuler un service extra ou périscolaire");
...
a("SuiviResultatsCompetences.fenetreOptionsAff.wai.SelectionPourcentage", "Sélectionnez un pourcentage minimal des évaluations qui ont le niveau %s");
...
a("stage.listeStagiaire.denominationCommerciale", "Dénomination commerciale");
...
a("FicheStage.listeSuivis.etatPublication", "Publier sur les Espaces Parents et Élèves");
...
a("FicheStage.fenetreRespAdmin.cbProfEquipePeda", "Professeurs de l'équipe pédagogique");
...
a("dossierVS.discussionPeda", "Discussion avec l'équipe pédagogique et les CPE");
...
a("CahierDeTexte.TAFARendre.EnregistrementADeposer", "Audio - A enregistrer sur l'Espace Élèves ( 3 min. max)");
...
a("CahierDeTexte.DevoirSurveille_Evaluation", "Évaluation de compétences programmée");
...
a("Orientation.Ressources.ChoixDefinitifsFamille", "Choix définitifs de la famille");
...
a("Orientation.Specialites.AjoutImpossible", "Ajout impossible. Vous avez atteint le nombre maximal de spécialités");
a("Orientation.Specialites.AucuneSpecialiteDisponible", "Toutes les spécialités disponibles ont été sélectionnées");
...
a("Orientation.AR.RetourFamilleASaisirAvant", "Retour de la famille à saisir avant le %s");
a("Orientation.AR.RetourFamille", "Retour de la famille");
a("Orientation.AR.ReponseFamilleASaisirAvant", "Réponse de la famille à saisir avant le %s");
a("Orientation.AR.ReponseFamilleSaisiePar", "Réponse de la famille saisie par %s le %s");
...
a("Orientation.LanguesOptions.msgSuppression", "Voulez-vous supprimer ce choix ?");
...
a("TvxIntendance.colonne.dureeInterventionLong", "Durée de l'intervention");
...
a("Casier.IntervenantDiffusion", "Diffuser aux Professeurs, Personnels <br>et Maitre de stage");
a("Casier.IntervenantDiffusionSansBr", "Diffuser aux Professeurs, Personnels et Maitre de stage");
...
a("Casier.deposerNouveauMaitre", "Déposer dans le casier de tout nouveau maître de stage créé");
a("Casier.deposerNouveauPersonnel", "Déposer dans le casier de tout nouveau personnel créé");
a("Casier.deposerNouveauProfesseur", "Déposer dans le casier de tout nouveau professeur créé");
a("Casier.deposerNouveauResponsable", "Déposer dans le casier de tout nouveau responsable créé");
a("Casier.deposeNouveauPersonnel", "Déposé dans le casier de tout nouveau personnel créé");
a("Casier.deposeNouveauProfesseur", "Déposé dans le casier de tout nouveau professeur créé");
a("Casier.deposeNouveauResponsable", "Déposé dans le casier de tout nouveau responsable créé");
...
a("Casier.uniqSansDepot", "Uniquement ceux n'ayant pas déposé le document");
a("Casier.telechargerLeDocument", "Télécharger le document");
a("Casier.diffuserUneInfo", "Diffuser une information au(x) responsable(s)");
...
a("Casier.sansCollecte", "Le document sélectionné ne peut pas être collecté, aucune classe n'est concernée.");
...
a("DernieresNotes.Detail.DetailsMethodeCalcMoy", "Détails du calcul de la moyenne");
...
a("blog.fenetreEditionBlog.RoleModerateurs", "Peuvent accepter ou refuser la publication des billets");
a("blog.fenetreEditionBlog.Redacteurs", "Rédacteurs");
a("blog.fenetreEditionBlog.RoleRedacteursJusquau", "Peuvent rédiger des billets jusqu'au");
a("blog.fenetreEditionBlog.Public", "Public supplémentaire");
a("blog.fenetreEditionBlog.RolePublic", "Peut consulter et commenter en plus des modérateurs et rédacteurs désignés");
a("blog.fenetreEditionBlog.AutoriserCommentaires", "Autoriser les commentaires (jusqu'à la date limite de rédaction des billets)");
...
a("blog.fenetreEditionBlog.MsgAucunTitreBlog", "Veuillez saisir un titre au blog");
a("blog.fenetreEditionBlog.MsgAucunModerateur", "Vous devez sélectionner au moins un modérateur");
a("blog.fenetreEditionBlog.MsgAucunRedacteur", "Vous devez sélectionner au moins un rédacteur");
...
a("inscriptionsEtablissement.fratrieTitre", "Fratrie dans l'établissement");
...
a("inscriptionsEtablissement.responsabilites", "Niveau de responsabilité");
...
a("inscriptionsEtablissement.optionObligatoire", "Option(s) obligatoire(s)");
a("inscriptionsEtablissement.optionFacultative", "Option(s) facultative(s)");
...
a("inscriptionsEtablissement.aucuneSession", "Aucune session d'inscription n'est en cours dans votre établissement à cette date.");
a("inscriptionsEtablissement.selectionnerSession", "Sélectionnez une session pour vous y inscrire ou pour consulter votre dossier");
a("inscriptionsEtablissement.inscriptionImpossible", "Inscription impossible");
a("inscriptionsEtablissement.inscriptionPossible", "L'inscription sera possible à partir du %s");
a("inscriptionsEtablissement.inscriptionDisponible", "L'inscription est disponible jusqu'au %s");
a("inscriptionsEtablissement.inscriptionTerminee", "L'inscription est terminée depuis le %s");
a("inscriptionsEtablissement.limiteAtteinte", "Le nombre maximum d'inscriptions a été atteint");
a("inscriptionsEtablissement.telechargerDemande", "Télécharger ma demande d'inscription");
a("inscriptionsEtablissement.modifierDemande", "Modifier ma demande d'inscription");
a("inscriptionsEtablissement.inscriptionEnvoyee", "Votre inscription a bien été prise en compte");
a("inscriptionsEtablissement.inscriptionModifiee", "La modification de votre inscription a bien été prise en compte");
...
a("inscriptionsEtablissement.recapAttente", "Demande en cours de traitement");
...
a("inscriptionsEtablissement.lettres", "Ce champ ne peut pas contenir de chiffres");
a("inscriptionsEtablissement.chiffres", "Ce champ ne peut pas contenir de lettres");
a("inscriptionsEtablissement.CPNonValide", "Ce code postal ne semble pas valide");
a("inscriptionsEtablissement.telephoneNonValide", "Ce numéro de téléphone ne semble pas valide");
...
a("inscriptionsEtablissement.villeNonTrouvee", "Cette ville n'a pas été trouvée");
a("inscriptionsEtablissement.paysNonTrouve", "Ce pays n'a pas été trouvé");
a("inscriptionsEtablissement.professionNonTrouvee", "Cette profession n'a pas été trouvée");
a("inscriptionsEtablissement.etablissementNonTrouve", "Cet établissement n'a pas été trouvé");
a("inscriptionsEtablissement.ProjetAccompagnement", "Projet d'accompagnement en cours");
a("inscriptionsEtablissement.CommentaireProjets", "Commentaire sur le projet");
a("inscriptionsEtablissement.hebergeEnfant", "Héberge l'élève postulant");
a("inscriptionsEtablissement.responsableFinancier", "Responsable financier");
a("inscriptionsEtablissement.percoitAides", "Perçoit les aides");
a("inscriptionsEtablissement.infosAdministrativesCourt", "Informations administratives");
...
a("inscriptionsEtablissement.afficherFormulaire", "Afficher le formulaire d'inscription");
a("inscriptionsEtablissement.enAttenteTraitement", "En attente de traitement");
a("inscriptionsEtablissement.enCoursTraitement", "En cours de traitement");
...
a("inscriptionsEtablissement.adresse1", "N° appartement ou bâtiment - Étage - Couloir - Escalier");
a("inscriptionsEtablissement.adresse2", "Entrée - Bâtiment - Immeuble - Résidence");
a("inscriptionsEtablissement.adresse3", "Numéro - Libellé de la voie");
a("inscriptionsEtablissement.adresse4", "Lieu-dit ou Service particulier de distribution");
a("inscriptionsEtablissement.copierAdresseResponsable", "Copier celle du responsable 1");
a("inscriptionsEtablissement.copierAdresseEnfant", "Copier celle de l'enfant");
a("inscriptionsEtablissement.msgValidation", "En validant ce formulaire d'inscription, vous acceptez que les données à caractères personnelles que vous avez renseignées soient utilisées dans le cadre du traitement de votre dossier");
a("inscriptionsEtablissement.msgFormulaireInvalide", "Certains champs obligatoires * ne sont pas renseignés (en rouge)");
a("inscriptionsEtablissement.msgConfirmationSuppression", "Toutes les informations renseignées vont être perdues. Confirmez-vous la suppression de cette demande d'inscription ?");
a("inscriptionsEtablissement.msgConfirmationAnnulation", "Toutes les informations renseignées vont être perdues. Confirmez-vous l'annulation de cette demande d'inscription ?");
a("inscriptionsEtablissement.demandeSupprimee", "Votre demande d'inscription a bien été supprimée");
a("inscriptionsEtablissement.msgAvertissementConsigne", "Si vous quittez le formulaire avant d'avoir validé la dernière étape, les informations renseignées seront perdues");
a("inscriptionsEtablissement.msgOptionsObligatoires", "Veuillez sélectionner %s option(s) obligatoire(s)");
...
a("FenetreCloud.GlissezDeposer_Cloud", "Glissez vos fichiers ou cliquez ici pour les deposer");
...
a("FenetreCloud.SelectionnerRepertoire_S", "Sélectionner le répertoire %s");
