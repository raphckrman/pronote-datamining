...
a("LienPolitiqueMotDePasse.UrlFAQMotDePasse", "https://www.index-education.com/redirect.php?produit=pn&page=comment-renforcer-securite&version=2024.3.8.0&distrib=FR&lg=fr&flag=Espace_Professeur&type=LienDocProduit");
...
a("incidents.protagonistes.msgConfSuppr", "Confirmez-vous la suppression de la mesure disciplinaire ?");
...
a("punition.fenetreDatePub.PublierImmediatement", "Publier immédiatement");
a("punition.fenetreDatePub.PublierDemain", "Publier demain");
a("punition.fenetreDatePub.PublierLe", "Publier le");
a("punition.publieeDepuisLe", "La punition est publiée dans le récapitulatif de la vie scolaire sur l'Espace Parents depuis le %s");
a("punition.seraPublieeLe", "La punition sera publiée dans le récapitulatif de la vie scolaire sur l'Espace Parents le %s");
...
a("AppelInternat.messConfirmezSaisieAbsenceInternatSurStage", "Cet élève n'est pas prévu à l'internat pendant la durée de son stage (Stages > Fiche de stage > Horaires).\nSouhaitez-vous tout de même le signaler absent de l'internat ?");
a("AppelInternat.messConfirmezSaisieRetardInternatSurStage", "Cet élève n'est pas prévu à l'internat pendant la durée de son stage (Stages > Fiche de stage > Horaires).\nSouhaitez-vous tout de même le signaler en retard à l'internat ?");
}
},fn:'traductions.js'});