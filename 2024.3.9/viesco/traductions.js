  ...
  f: function (exports, require, module, global) {
    ...
    module.exports = function (a) {
      ...
      a(
        ...
        'https://www.index-education.com/redirect.php?produit=pn&page=comment-renforcer-securite&version=2024.3.9.0&distrib=FR&lg=fr&flag=Espace_Etablissement&type=LienDocProduit',
      );
      a(
        'AvertissementDemo',
      ...
      a('SuiviJustificationAbsRet.AouR', 'A ou R');
      a('SuiviJustificationAbsRet.AbsenceOuRetard', 'Absence ou retard');
      ...
      a(
        ...
        'Justification donnée par les parents',
      );
      a(
        'SuiviJustificationAbsRet.RaisonDonneeParents',
        'Raison donnée par les parents',
      );
      ...
      a('SuiviJustificationAbsRet.JustifiePar', 'Justifié par');
