IE.fModule({
  f: function (exports, require, module, global) {
    ...
    module.exports = function (a) {
      ...
      a('QRCode', 'QRCode');
      a('QRCodeAppliMobile', "QRCode à flasher avec l'application mobile");
      a('ChampsObligatoires', 'Champs obligatoires');
      a('MarqueurChampsObligatoires', '*');
      a('XCaracteresMax_D', '%d caractères maximum');
      ...
      a('calendrier.WAI.SelecPeriode', 'Sélectionner une période');
      a(
      ...
      a('CentraleNotifications.AucuneNotification', 'Aucune notification');
      a('CentraleNotifications.Notification_S', '%s notification');
      a('CentraleNotifications.Notifications_S', '%s notifications');
      ...
      a('CentraleNotifications.Lues_S', '%s lues');
      a(
      ...
      a(
        'ImportExport.ChoisirFichierImport',
        'Choisissez le fichier à importer',
      );
      a('ImportExport.TitreFenetre', 'Import de données');
      a(
        'ImportExport.AucuneDonneeDansFichierImport',
        'Le fichier importé ne contient pas de données',
      );
      ...
      a(
        'ImportExport.HintChpOlbManquant',
        "Le champ obligatoire %s n'est pas spécifié",
      );
      a(
        'ImportExport.HintMauvaisGenre',
        "Le format de %s n'est pas celui attendu",
      );
      a(
        'ImportExport.HintMauvaisEnumere',
        'La valeur doit appartenir à la liste de valeurs suivantes :\n%s',
      );
      a(
      ...
      a(
        ...
        'La valeur "%s" est trop longue (%d caractères pour %d caractères maximum)',
      );
      a(
        'ImportExport.HintLongueurMin',
        'La valeur "%s" n\'est pas assez longue (%d caractères pour %d caractères minimum)',
      );
      a(
        'ImportExport.HintNombreDouble',
        'La valeur "%s" n\'est pas un nombre réel valide.',
      );
      a(
        'ImportExport.HintNombreEntier',
        'La valeur "%s" n\'est pas un nombre entier valide.',
      );
      a(
        'ImportExport.HintValeurMax',
        'Elle doit être inférieure ou égale à %s.',
      );
      a(
        'ImportExport.HintValeurMin',
        'Elle doit être supérieure ou égale à %s.',
      );
      a(
        'ImportExport.LegendeChpObl',
        '* Au moins un de ces champs est obligatoire',
      );
      a(
        'ImportExport.LegendeDetailNbChpOblManquant',
        '%d champ(s) manquant(s).',
      );
      a('ImportExport.FichierErreur', 'Erreur sur la sélection du fichier');
      a(
        'ImportExport.FichierTailleIncorrect',
        'La taille du fichier est trop importante pour être importée',
      );
      a(
        'ImportExport.FichierFormat',
        "Le fichier sélectionné ne permet pas d'importer des données. Veuillez vérifier la dispostion des données ou changez le type de fichier",
      );
      ...
      a('SaisieVocale.CaptureAudio', 'Capture audio');
      a(
      ...
      a(
        'AppliMobile.AccesSiteMobile',
        'Accès au site mobile depuis un navigateur',
      );
      a(
        'AppliMobile.ErreurRequete',
        "Le code n'a pas pu être généré, veuillez réessayer ultérieurement.",
      );
      a('AppliMobile.CodeVerification', 'Code de vérification à 4 chiffres :');
      a(
        'AppliMobile.MethodeConfig',
        "Depuis un téléphone, installer l'application %s (disponible sur tous les stores).",
      );
      a(
        'AppliMobile.MethodeConfigSuite',
        'Dans la "Gestion des comptes", flashez ce QR Code.',
      );
      a(
        'AppliMobile.MethodeConfigFin',
        'Saisissez votre code de vérification défini précédemment (durée de validité 10min)',
      );
      a('AppliMobile.GenererQRCode', 'Générer le QR Code');
      a('AppliMobile.ChangerCompte', 'Changer de compte');
      ...
      a(
        ...
        'Renforcer la sécurité et éviter le piratage des comptes',
      );
      ...
      a('DoubleAuth.Retour', 'Retour');
      a('DoubleAuth.TitreValiderCodePIN', 'Mon code PIN');
      a(
        'DoubleAuth.RenforcerSecurite',
        'Renforcer la sécurité de votre compte',
      );
      a('DoubleAuth.EnSavoirPlus', 'En savoir plus');
      a(
      ...
      a('DoubleAuth.StrategieFort', 'Fort');
      a('DoubleAuth.StrategieMoyen', 'Moyen');
      a('DoubleAuth.StrategieAucun', 'Aucun');
      a(
        'DoubleAuth.LegendeChoixStratTitre',
        'A chaque connexion sur un nouvel appareil',
      );
      a('DoubleAuth.LegendeChoixStratPIN', 'Saisie du code PIN');
      a('DoubleAuth.LegendeChoixStratNotif', "Réception d'une notification");
      a('DoubleAuth.MonCodePIN', 'Mon code');
      a('DoubleAuth.PremierPIN', '1ère saisie');
      a('DoubleAuth.ConfirmPIN', 'Confirmation');
      a('DoubleAuth.CodeRecuPIN', 'Code reçu');
      a('DoubleAuth.NouveauCodePIN', 'Nouveau code');
      a(
        'DoubleAuth.MessageCreationCodePIN',
        'Votre code PIN vous sera demandé à chaque connexion sur un appareil non enregistré',
      );
      a('DoubleAuth.EnregistrerSousNom', 'Enregistrer sous le nom');
      a('DoubleAuth.NbCaracteresMax_D', '%d caractères maximum');
      a(
      ...
      a('DoubleAuth.WAI_MonCodeValide', 'Mon code est validé.');
      a('DoubleAuth.Effacer', 'Effacer');
      a(
        'DoubleAuth.InfoSaisiePIN',
        'Saisissez votre code dans le pavé numérique',
      );
      ...
      a('DoubleAuth.Details', 'Détails');
      a('DoubleAuth.Client', 'Client');
      a('DoubleAuth.Mobile', 'Mobile');
      a('DoubleAuth.Navigateur', 'Navigateur');
      a('DoubleAuth.EnregistrerAppareilTitre', 'Enregistrer cet appareil');
      a(
      ...
      a('DoubleAuth.AucunAppareilEnregistre', 'Aucun appareil enregistré');
      ...
      a(
        'DoubleAuth.RenforcerSecuInfoPIN',
      ...
      a('DoubleAuth.SecuriteRenforcee', 'Renforcement de la sécurité');
      a('theme.0', 'Bordeaux');
      a('theme.1', 'Jaune');
      a('theme.2', 'Bleu');
      a('theme.3', 'Turquoise');
      ...
      a('PageNotes.WAITitreDevoir_S', 'Devoir du %s');
      ...
      a(
        ...
        'Activer la surlignage sur la lecture des mots',
      );
      ...
      a(
        'Vacances.MessageVacancesNonDefinis',
        "Les vacances et jours fériés n'ont pas été définis.",
      );
      ...
      a('Import.ChampIgnore', 'A associer');
      a(
        'Import.BaremePremiereLigne',
        'Barème des notes sur la première ligne importée',
      );
      a(
      ...
      a('documentsATelecharger.aTelecharger', 'A télécharger');
      ...
      a(
        ...
        'https://www.index-education.com/redirect.php?produit=pn&page=comment-renforcer-securite&version=2024.3.9.0&distrib=FR&lg=fr&flag=Espace_Professeur&type=LienDocProduit',
      );
      a(
        'AvertissementDemo',
      ...
      a('accueil.FAST.titre', 'Activités péri et extra scolaires');
      a('accueil.FAST.GestionInscriptions', 'Gestion des inscriptions');
      a('accueil.FAST.periscolaire', 'Périscolaire (cantine, garderie...)');
      a('accueil.FAST.extrascolaire', 'Extra-scolaire (mercredi, vacances)');
      a('accueil.FAST.InscrireMonEnfant', 'Inscrire mon enfant');
      a('accueil.FAST.GestionReservations', 'Gestion des réservations');
      a(
        'accueil.FAST.reserverAnnulerService',
        'Réserver, annuler un service extra ou périscolaire',
      );
      ...
      a('actualites.DocumentsJoints', 'Documents joints');
      a('actualites.DocumentJoint', 'Document joint');
      a(
      ...
      a('stage.listeStagiaire.referants', 'Professeurs référents');
      ...
      a('stage.listeStagiaire.adresse', 'Adresse');
      a('stage.listeStagiaire.telephone', 'Téléphone');
      a('stage.listeStagiaire.email', 'Email');
      a(
        'stage.listeStagiaire.denominationCommerciale',
      ...
      a('dossierVieScolaire.fenetre.respAdmin', 'Responsable du dossier');
      ...
      a(
        ...
        'Sélection des classes et des groupes',
      );
      ...
      a('incidents.rapporteur', 'Auteur du signalement');
      ...
      a(
        ...
        "Actions immédiates menées par l'établissement",
      );
      ...
      a('incidents.protagonistes.suiteADonner', 'Suite à donner');
      a('incidents.protagonistes.oui', 'O');
      a('incidents.protagonistes.non', 'N');
      a('incidents.protagonistes.hintOui', 'Oui');
      a('incidents.protagonistes.hintNon', 'Non');
      a('incidents.protagonistes.mesures', 'Nature');
      a('incidents.protagonistes.date', 'Date');
      a(
        'incidents.protagonistes.pubDossier',
        "Publier le dossier lié à l'incident dans les dossiers de la vie scolaire sur l'Espace parents",
      );
      a(
        'incidents.protagonistes.publier',
        "Publier l'incident dans le récapitulatif de la vie scolaire sur l'Espace parents",
      );
      ...
      a('incidents.protagonistes.supprimer', 'Supprimer le protagoniste');
      a('incidents.protagonistes.enAttente', 'En attente de décision');
      a('incidents.protagonistes.aucuneMesure', 'Aucune mesure disciplinaire');
      a(
        'incidents.protagonistes.msgConfSuppr',
        'Confirmez-vous la suppression de la mesure disciplinaire ?',
      );
      ...
      a(
        ...
        "Informer l'équipe pédagogique de l'élève et les CPE",
      );
      ...
      a('punition.fenetreDatePub.Titre', 'Date de publication');
      a('punition.fenetreDatePub.NonPubliee', 'Non publiée');
      a(
        'punition.fenetreDatePub.PublierImmediatement',
        'Publier immédiatement',
      );
      a('punition.fenetreDatePub.PublierDemain', 'Publier demain');
      a('punition.fenetreDatePub.PublierLe', 'Publier le');
      a(
        'punition.publieeDepuisLe',
        "La punition est publiée dans le récapitulatif de la vie scolaire sur l'Espace Parents depuis le %s",
      );
      a(
        'punition.seraPublieeLe',
        "La punition sera publiée dans le récapitulatif de la vie scolaire sur l'Espace Parents le %s",
      );
      a(
        'punition.nonPubliee',
      ...
      a('fenetreCommunication.profPrincipal', 'Professeur principal');
      a('fenetreCommunication.tuteur', 'Tuteur');
      a('fenetreCommunication.monCPE', 'CPE de mon enfant');
      ...
      a('infosperso.MessagerieSignature', 'Signature des discussions');
      a(
      ...
      a(
        'progression.msgAucune',
        'Créez une Préparation puis ajoutez vos fiches',
      );
      a(
        'progression.msgAucuneProg',
        'Sélectionnez une matière pour créer des fiches de préparation liées à cette matière.',
      );
      a(
        'progression.msgAucunContenu',
        'Créer une nouvelle fiche pour commencer la préparation',
      );
      ...
      a(
        'progression.msgConfirmSupprFiche',
        'Confirmez-vous la suppression de cette fiche ?',
      );
      a('progression.cible', 'Progression cible');
      a('progression.dupliquerContenu', 'Dupliquer la séance %s');
      a(
        'progression.infoDupliquer',
        'La nouvelle séance sera placée à la fin de la progression cible.',
      );
      a('progression.modifierProgression', 'Modifier la Préparation');
      a(
        'progression.msgConfirmSupprProgression',
        'Confirmez-vous la suppression de la progression ?',
      );
      ...
      a(
        ...
        'Évaluation de compétences programmée',
      );
      ...
      a('FenetreListeTAFFaits.FenetreProlongationRendu.xEleves', '%d élèves');
      a(
      ...
      a('EDT.DevoirSurveille', 'Devoir surveillé');
      a('EDT.EvaluationCompetence', 'Evaluation de compétences');
      ...
      a(
        'ListeDevoirs.hint.DatePublication',
        'Date à laquelle le devoir est publié dans le relevé de notes sur Internet',
      );
      ...
      a(
        'ListeDevoirs.hint.Cloturee',
        'Indique si le devoir est sur une période clôturée.',
      );
      ...
      a(
        'Orientation.Ressources.DispoEtablissement',
        "Proposées par l'établissement",
      );
      a(
        'Orientation.Ressources.DispoHorsEtablissement',
        "Uniquement hors de l'établissement",
      );
      a(
        'Orientation.Ressources.AvisProvisoireCC',
        'Avis provisoires du conseil de classe',
      );
      a(
      ...
      a(
        ...
        "Intentions d'orientation de la famille",
      );
      a(
      ...
      a(
        ...
        'Choix définitifs de la famille',
      );
      a(
      ...
      a(
        'Orientation.Ressources.MsgDecisionRetenue',
      ...
      a(
        'Orientation.Specialites.TitreListe',
      ...
      a(
        ...
        'Voulez-vous supprimer la spécialité ?',
      );
      a(
        'Orientation.Specialites.UniquementSpecialiteEleve',
      ...
      a(
        ...
        'Cliquez ici pour choisir une option',
      );
      ...
      a(
        'Orientation.SaisiePriseEnCompte',
        'Votre saisie a bien été prise en compte',
      );
      a(
        'Orientation.AR.RetourFamilleASaisirAvant',
        'Retour de la famille à saisir avant le %s',
      );
      a('Orientation.AR.RetourFamille', 'Retour de la famille');
      a(
        'Orientation.AR.ReponseFamilleASaisirAvant',
        'Réponse de la famille à saisir avant le %s',
      );
      a(
        'Orientation.AR.ReponseFamilleSaisiePar',
        'Réponse de la famille saisie par %s le %s',
      );
      a(
        'Orientation.AR.PropositionCCStageAR',
      ...
      a(
        'Orientation.AR.NousAcceptonsSuite',
        'la proposition du conseil de classe suivante :',
      );
      a(
        'Orientation.AR.MsgARProposition',
      ...
      a(
        'Orientation.AR.NousAcceptonsAucuneSuite',
        "des propositions du conseil de classe et prenons immédiatement contact avec le chef d'établissement.",
      );
      a(
        'Orientation.AR.MsgAttentionSaisieAR',
        "Attention, vous avez jusqu'au %s pour donner votre réponse sur la proposition du conseil de classe.",
      );
      a(
        'Orientation.MsgAucuneOrientation',
        "Aucune information n'a été renseignée. La période de saisie est clôturée",
      );
      a(
        'Orientation.AucuneOrientation',
        "Aucune orientation n'a été renseignée.",
      );
      a('Orientation.Commentaire', 'Commentaire');
      a('Orientation.PublieSurEspaceParent', "Publié sur l'Espace Parent");
      a('Orientation.ASaisirJusqau', "(à saisir jusqu'au %s)");
      a('Orientation.LanguesOptions.titre', 'Langues vivantes et options');
      a('Orientation.LanguesOptions.LV1', 'LV1');
      a('Orientation.LanguesOptions.LV2', 'LV2');
      a('Orientation.LanguesOptions.Options', 'Options (%d)');
      a('Orientation.LanguesOptions.bouton', 'Valider le choix des langues');
      a('Orientation.LanguesOptions.TitreListeLV1', 'Choix de la LV1');
      a('Orientation.LanguesOptions.TitreListeLV2', 'Choix de la LV2');
      a(
        'Orientation.LanguesOptions.msgSuppression',
        'Voulez-vous supprimer ce choix ?',
      );
      a('Orientation.LanguesOptions.titreMsgErreur', 'Affectation impossible');
      a(
      ...
      a(
        ...
        "Autres évènements signalés dans les feuilles d'appel",
      );
      ...
      a(
        ...
        'Saisir un nouvel encouragement',
      );
      a(
      ...
      a('FenetreParamExecutionQCM.QuestionsPrisesAuHasard', 'questions');
      a(
      ...
      a('Casier.renommerLeFichier', 'Renommer le fichier');
      ...
      a('Casier.ajouterUnMemo', 'Ajouter un mémo');
      ...
      a('Casier.monCasier', 'Mon casier');
      a('Casier.Intervenant', 'Professeurs, Personnels <br>et Maitre de stage');
      a(
        'Casier.IntervenantDiffusion',
        'Diffuser aux Professeurs, Personnels <br>et Maitre de stage',
      );
      a(
        'Casier.IntervenantDiffusionSansBr',
        'Diffuser aux Professeurs, Personnels et Maitre de stage',
      );
      a('Casier.responsables', 'Responsables');
      a('Casier.responsablesDiffusion', 'Diffuser aux Responsables');
      a('Casier.diffusion', 'Diffusion');
      a('Casier.choisirUneCategorie', 'Choisir une nature');
      a(
        'Casier.deposerNouveauMaitre',
        'Déposer dans le casier de tout nouveau maître de stage créé',
      );
      a(
        'Casier.deposerNouveauPersonnel',
        'Déposer dans le casier de tout nouveau personnel créé',
      );
      a(
        'Casier.deposerNouveauProfesseur',
        'Déposer dans le casier de tout nouveau professeur créé',
      );
      a(
        'Casier.deposerNouveauResponsable',
        'Déposer dans le casier de tout nouveau responsable créé',
      );
      a(
        'Casier.deposeNouveauPersonnel',
        'Déposé dans le casier de tout nouveau personnel créé',
      );
      a(
        'Casier.deposeNouveauProfesseur',
        'Déposé dans le casier de tout nouveau professeur créé',
      );
      a(
        'Casier.deposeNouveauResponsable',
        'Déposé dans le casier de tout nouveau responsable créé',
      );
      ...
      a('Casier.du', 'Du');
      a('Casier.au', 'Au');
      a('Casier.documentsACollecter', 'Documents à collecter');
      a('Casier.recapitulatifParEleve', 'Récapitulatif par élève');
      a('Casier.collecte', 'Collecte');
      ...
      a('Casier.depotEtablissement', "Dépôt par l'établissement uniquement");
      ...
      a(
        ...
        'Diffuser une information au(x) responsable(s)',
      );
      ...
      a(
        'Casier.sansCollecte',
        "Le document sélectionné ne peut pas être collecté, aucune classe n'est concernée.",
      );
      ...
      a(
        ...
        'Niveaux pour lesquels la compétence est évaluée',
      );
      a(
      ...
      a(
        ...
        "La saisie d'un niveau (sur une échelle de 1 à 8) est nécessaire pour positionner les élèves sur chaque compétence numérique.",
      );
      a(
      ...
      a('FenetreCloud.Deposer_Cloud', 'Déposer un fichier');
      ...
      a('FenetreCloud.ActualisationRepertoire', 'Actualisation du répertoire');
      a(
        'FenetreCloud.SelectionnerRepertoire_S',
        'Sélectionner le répertoire %s',
      );
      a('FenetreCloud.Hint_Repertoire', 'Répertoire');
      a('Commissions.publieePourParents', "Publiée sur l'Espace Parents");
      ...
      a(
        ...
        "Cet élève n'est pas prévu à l'internat pendant la durée de son stage (Stages > Fiche de stage > Horaires).\nSouhaitez-vous tout de même le signaler absent de l'internat ?",
      );
      a(
