IE.fModule({
  f: function (exports, require, module, global) {
    ...
    const ObjetScroll_module_css_1 = require('@cp/script/css/ObjetScroll.module.css');
    var EGenreScroll;
    ...
    class ObjetScroll extends ObjetIdentite_1.Identite {
      constructor(aParams) {
        ...
        this.Genre =
          (_a = aParams.genreScroll) !== null && _a !== void 0
            ? _a
      ...
      jsxNodeScroll(aNode) {
        $(aNode).on('scroll', () => {
          ...
          if (!this._tickingScroll) {
            if (window.requestAnimationFrame) {
              window.requestAnimationFrame(() => {
                this.evenementSurScroll(_getPosition());
                delete this._tickingScroll;
              });
            } else {
              this.evenementSurScroll(_getPosition());
            }
          }
          this._tickingScroll = true;
        });
      }
      compose() {
        ...
        return IE.jsx.str(
          'div',
          {
            class: ObjetScroll_module_css_1.SObjetScroll.ObjetScroll,
            style: LStyleScroll,
            role: 'presentation',
          },
          IE.jsx.str(
            ...
            {
              id: this.Nom,
              ie_node: this.jsxNodeScroll.bind(this),
              class: [
                this.Genre === EGenreScroll.Horizontal
                  ? ObjetScroll_module_css_1.SObjetScroll.horizontal
                  : ObjetScroll_module_css_1.SObjetScroll.vertical,
              ],
              style: LStyleScroll,
              tabindex: '-1',
              role: 'presentation',
      ...
      surModificationHeightContenu() {
        ...
        lJScroll
          .find(`>.${ObjetScroll.StylesSelectScroll.realScroll}`)
          .css('height', `${lTailleContenu}px`);
        return true;
      }
      _getTailleContenu() {
    ...
    ObjetScroll.StylesSelectScroll = { realScroll: 'real-scroll' };
  },
  fn: 'objetscroll.js',
});