  ...
  f: function (exports, require, module, global) {
    ...
    module.exports.trad = function (a) {
      ...
      a(
        ...
        'https://swie.index-education.com/redirect.php?produit=pn&page=comment-renforcer-securite&version=2026.1.3.0&distrib=FR&lg=fr&flag=Espace_Parent&type=LienDocProduit',
      );
      a(
        'AvertissementDemo',
      ...
      a(
        ...
        'Saisie des allergies répertoriées',
      );
      ...
      a(
        ...
        'uniquement les messages, informations et sondages des responsables',
      );
      ...
      a('inscriptionsEtablissement.responsable', 'Responsable %s');
      a('inscriptionsEtablissement.civilite', 'Civilité');
      a('inscriptionsEtablissement.nom', 'Nom');
      a('inscriptionsEtablissement.nomNaissance', 'Nom de naissance');
      a('inscriptionsEtablissement.prenom', 'Prénom');
      a('inscriptionsEtablissement.adresse', 'Adresse');
      a('inscriptionsEtablissement.ville', 'Ville');
      a('inscriptionsEtablissement.CPVille', 'Code postal');
      a('inscriptionsEtablissement.pays', 'Pays');
      a('inscriptionsEtablissement.telephone', 'Téléphone');
      a('inscriptionsEtablissement.telephoneMobile', 'Téléphone mobile');
      a(
        'inscriptionsEtablissement.telephoneIndicatif',
        'Indicatif téléphonique',
      );
      a('inscriptionsEtablissement.email', 'E-mail');
      a(
        'inscriptionsEtablissement.fratrieTitre',
        "Fratrie dans l'établissement",
      );
      a('inscriptionsEtablissement.classe', 'Classe actuelle');
      a('inscriptionsEtablissement.oui', 'Oui');
      a('inscriptionsEtablissement.non', 'Non');
      a('inscriptionsEtablissement.garcon', 'Garçon');
      a('inscriptionsEtablissement.fille', 'Fille');
      a('inscriptionsEtablissement.situation', 'Situation professionnelle');
      a('inscriptionsEtablissement.profession', 'Profession');
      a('inscriptionsEtablissement.identiteEnfant', "Identité de l'enfant");
      a('inscriptionsEtablissement.sexe', 'Sexe');
      a('inscriptionsEtablissement.dateNaissance', 'Date de naissance');
      a('inscriptionsEtablissement.villeNaissance', 'Lieu de naissance');
      a('inscriptionsEtablissement.paysNaissance', 'Pays de naissance');
      a('inscriptionsEtablissement.lien', 'Lien de parenté');
      a('inscriptionsEtablissement.ine', 'Numéro national étudiant');
      a('inscriptionsEtablissement.boursier', 'Boursier');
      a(
        'inscriptionsEtablissement.responsabilites',
        'Niveau de responsabilité',
      );
      a('inscriptionsEtablissement.etabActuel', 'Etablissement actuel');
      a('inscriptionsEtablissement.redoublant', 'Redoublant');
      a('inscriptionsEtablissement.regime', 'Régime');
      a('inscriptionsEtablissement.scolariteSouhaitee', 'Scolarité souhaitée');
      a('inscriptionsEtablissement.classeSouhaitee', 'Classe');
      a('inscriptionsEtablissement.formation', 'Formation souhaitée');
      a('inscriptionsEtablissement.formations', 'Formation(s)');
      a(
        'inscriptionsEtablissement.optionObligatoire',
        'Option(s) obligatoire(s)',
      );
      a(
        'inscriptionsEtablissement.optionFacultative',
        'Option(s) facultative(s)',
      );
      a('inscriptionsEtablissement.optionLV1', 'LV1');
      a('inscriptionsEtablissement.optionLV2', 'LV2');
      a('inscriptionsEtablissement.maximum', 'maximum : %s');
      a('inscriptionsEtablissement.attendues', 'attendue(s): %s');
      a(
        'inscriptionsEtablissement.aucuneSession',
        "Aucune session d'inscription n'est en cours dans votre établissement à cette date.",
      );
      a(
        'inscriptionsEtablissement.selectionnerSession',
        'Sélectionnez une session pour vous y inscrire ou pour consulter votre dossier',
      );
      a(
      ...
      a(
        ...
        "L'inscription sera possible à partir du %s",
      );
      a(
        'inscriptionsEtablissement.inscriptionDisponible',
        "L'inscription est disponible jusqu'au %s",
      );
      a(
        'inscriptionsEtablissement.inscriptionTerminee',
        "L'inscription est terminée depuis le %s",
      );
      a(
      ...
      a(
        ...
        "Télécharger ma demande d'inscription",
      );
      a(
        'inscriptionsEtablissement.modifierDemande',
        "Modifier ma demande d'inscription",
      );
      a(
      ...
      a(
        ...
        'La modification de votre inscription a bien été prise en compte',
      );
      a('inscriptionsEtablissement.numeroDossier', 'Numéro de dossier :');
      a('inscriptionsEtablissement.dateEnvoiDossier', 'Dossier envoyé le :');
      a('inscriptionsEtablissement.decision', 'Décision :');
      a(
        'inscriptionsEtablissement.recapAttente',
        'Demande en cours de traitement',
      );
      a('inscriptionsEtablissement.recapAccepte', 'Demande acceptée');
      a('inscriptionsEtablissement.recapRefuse', 'Demande refusée');
      a('inscriptionsEtablissement.formationDemandee', 'Formation demandée :');
      a('inscriptionsEtablissement.etatDemande', 'État de la demande :');
      a(
        'inscriptionsEtablissement.lettres',
        'Ce champ ne peut pas contenir de chiffres',
      );
      a(
        'inscriptionsEtablissement.chiffres',
        'Ce champ ne peut pas contenir de lettres',
      );
      a(
        'inscriptionsEtablissement.CPNonValide',
        'Ce code postal ne semble pas valide',
      );
      a(
        'inscriptionsEtablissement.telephoneNonValide',
        'Ce numéro de téléphone ne semble pas valide',
      );
      a('inscriptionsEtablissement.alphanumerique', 'Caractères non autorisés');
      a('inscriptionsEtablissement.dateNonValide', 'Date non valide');
      a(
      ...
      a(
        ...
        "Ce pays n'a pas été trouvé",
      );
      a(
        'inscriptionsEtablissement.professionNonTrouvee',
        "Cette profession n'a pas été trouvée",
      );
      a(
        'inscriptionsEtablissement.etablissementNonTrouve',
        "Cet établissement n'a pas été trouvé",
      );
      a(
        'inscriptionsEtablissement.ProjetAccompagnement',
        "Projet d'accompagnement en cours",
      );
      a(
        'inscriptionsEtablissement.CommentaireProjets',
        'Commentaire sur le projet',
      );
      a('inscriptionsEtablissement.hebergeEnfant', "Héberge l'élève postulant");
      a(
        'inscriptionsEtablissement.responsableFinancier',
        'Responsable financier',
      );
      a('inscriptionsEtablissement.percoitAides', 'Perçoit les aides');
      a(
        'inscriptionsEtablissement.infosAdministrativesCourt',
        'Informations administratives',
      );
      a('inscriptionsEtablissement.champsObligatoires', '*Champ obligatoire');
      a('inscriptionsEtablissement.consigne', 'Consigne');
      a('inscriptionsEtablissement.scolarite', 'Scolarité');
      a('inscriptionsEtablissement.responsables', 'Responsable(s)');
      a('inscriptionsEtablissement.documentAJoindre', 'Document(s) à joindre');
      a('inscriptionsEtablissement.mesDemandes', 'Mes demandes');
      a('inscriptionsEtablissement.sessionEnCours', 'Sessions en cours');
      a('inscriptionsEtablissement.titreEtape', 'Étape %d/%d - %s');
      a('inscriptionsEtablissement.envoyerDemande', 'Envoyer la demande');
      a('inscriptionsEtablissement.ouvertJusquau', "Ouverte jusqu'au %s");
      a(
      ...
      a('inscriptionsEtablissement.aCompleter', 'A compléter');
      a('inscriptionsEtablissement.traitee', 'Traitée');
      a('inscriptionsEtablissement.listeAttente', "En liste d'attente");
      a('inscriptionsEtablissement.annotation', 'Annotation');
      a(
        'inscriptionsEtablissement.adresse1',
        'N° appartement ou bâtiment - Étage - Couloir - Escalier',
      );
      a(
        'inscriptionsEtablissement.adresse2',
        'Entrée - Bâtiment - Immeuble - Résidence',
      );
      a('inscriptionsEtablissement.adresse3', 'Numéro - Libellé de la voie');
      a(
        'inscriptionsEtablissement.adresse4',
        'Lieu-dit ou Service particulier de distribution',
      );
      a(
        'inscriptionsEtablissement.copierAdresseResponsable',
        'Copier celle du responsable 1',
      );
      a(
        'inscriptionsEtablissement.copierAdresseEnfant',
        "Copier celle de l'enfant",
      );
      a(
        'inscriptionsEtablissement.msgValidation',
        "En validant ce formulaire d'inscription, vous acceptez que les données à caractères personnelles que vous avez renseignées soient utilisées dans le cadre du traitement de votre dossier",
      );
      a(
        'inscriptionsEtablissement.msgFormulaireInvalide',
        'Certains champs obligatoires * ne sont pas renseignés (en rouge)',
      );
      a(
        'inscriptionsEtablissement.msgConfirmationSuppression',
        "Toutes les informations renseignées vont être perdues. Confirmez-vous la suppression de cette demande d'inscription ?",
      );
      a(
        'inscriptionsEtablissement.msgConfirmationAnnulation',
        "Toutes les informations renseignées vont être perdues. Confirmez-vous l'annulation de cette demande d'inscription ?",
      );
      a(
        'inscriptionsEtablissement.demandeSupprimee',
        "Votre demande d'inscription a bien été supprimée",
      );
      a(
        'inscriptionsEtablissement.msgAvertissementConsigne',
        "Si vous quittez le formulaire avant d'avoir validé la dernière étape, les informations renseignées seront perdues",
      );
      a(
        'inscriptionsEtablissement.msgOptionsObligatoires',
        'Veuillez sélectionner %s option(s) obligatoire(s)',
      );
      a('inscriptionsEtablissement.pour', 'Pour %s');
      ...
      a('WidgetVoteElecElecteur.titre', 'Élections des parents');
      a(
        'WidgetVoteElecElecteur.invitElecteur1j',
        'En tant que parent vous êtes invité à prendre part aux élections suivantes le %s entre %s et %s :',
      );
      a(
        'WidgetVoteElecElecteur.invitElecteurNj',
        "En tant que parent vous êtes invité à prendre part aux élections suivantes du %s à %s jusqu'au %s à %s :",
      );
      a(
        'WidgetVoteElecElecteur.infoElecteurEnCours',
        "En tant que parent vous êtes invité à prendre part aux élections suivantes jusqu'au %s à %s",
      );
      a(
        'WidgetVoteElecElecteur.accesEspaceElecteur',
        "Accéder à la plateforme d'élections",
      );
      a(
        'WidgetVoteElecElecteur.infosCoordOTP',
        'Accédez à la plateforme au plus vite pour corriger si besoin les informations suivantes :',
      );
      a(
        'WidgetVoteElecElecteur.infosCoordOTPCtxScellee',
        "Les informations suivantes seront utilisées pour le vote. En cas d'erreur, contactez au plus vite votre établissement.",
      );
      a(
        'WidgetVoteElecElecteur.infoDesynchro',
        'Les modifications effectuées sur la plateforme ne sont pas immédiatement visibles sur votre Espace, pensez à actualiser',
      );
      a('WidgetVoteElecElecteur.email', 'E-mail');
      a('WidgetVoteElecElecteur.telephone', 'Téléphone');
