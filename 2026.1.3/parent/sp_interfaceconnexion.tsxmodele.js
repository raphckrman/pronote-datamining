IE.fModule({
  f: function (exports, require, module, global) {
    ...
    const getHtml = (aParams) => {
          ...
          lAvecLiens
            ? IE.jsx.str(
                'a',
                {
                  ...
                  ie_eventmap: {
                    click: () => $.get(aParams.options.suiviLien),
                  },
                },
                getHtmlImg(),
                IE.jsx.str(
      ...
      const lBtnGetTooltipModeConnex = () => {
        return (
          '<strong>' +
      ...
      return IE.jsx.str(
        ...
        IE.jsx.str(
          ...
          IE.jsx.str('div', {
            ie_identite: aParams.jsx.identiteBandeau,
          ...
          IE.jsx.str(
            ...
            IE.jsx.str(
              'div',
              {
                ...
                ie_if: aParams.jsx.visibiliteInscription,
                class: 'bloc-elem',
              ...
              IE.jsx.str(
                'div',
                { ie_display: aParams.jsx.displayBoutonRedirigerParent() },
                IE.jsx.str(
                  IEHtml_Bouton_1.Bouton,
                  {
                    ie_model: aParams.jsx.modelBoutonRedirigerParent(),
                    class:
                      'font-size-2xl AvecMain themeBoutonNeutre height-auto',
                    style:
              ...
              IE.jsx.str(
                ...
                IE.jsx.str(
                  IEHtml_Bouton_1.Bouton,
                  {
                    ie_model: aParams.jsx.modelBoutonCreationInscription(),
              ...
              IE.jsx.str(
                ...
                IE.jsx.str(
                  IEHtml_Bouton_1.Bouton,
                  {
                    ie_model: aParams.jsx.modelBoutonConnexionInscription(),
                    class: 'Texte12 AvecMain themeBoutonNeutre height-auto',
                    style:
                      'width:calc(100% - 20px);min-height:105px;text-align: left;border-radius:0;padding:20px;margin:0px 10px 10px 10px;',
                  },
            ...
            IE.jsx.str(
              'main',
              {
                ...
                ie_if: aParams.jsx.visibiliteConnexion,
                role: 'main',
              ...
              IE.jsx.str(
                ...
                IE.jsx.str(
                  'div',
                  {
                    ie_if: aParams.jsx.visibiliteModeConnexion,
                    class: 'connexion-wrapper field-contain',
                    role: 'group',
                    'aria-label': aParams.traductions.ariaDescrModeConnexion,
                  },
                  IE.jsx.str(
                    'label',
                    null,
                  ...
                  IE.jsx.str(
                    ...
                    { ie_model: aParams.jsx.modelRadioChoixConnexion(0) },
                    aParams.traductions.modeConnexion1,
                  ),
                  IE.jsx.str(
                    IEHtml_CheckboxRadio_1.Radio,
                    { ie_model: aParams.jsx.modelRadioChoixConnexion(1) },
                    aParams.traductions.modeConnexion2,
                  ),
                  IE.jsx.str(IEHtml_BtnImage_1.BtnTooltip, {
                    getTooltip: lBtnGetTooltipModeConnex,
                    class: [Divers_css_1.SD.mLeft],
                  }),
                ),
                IE.jsx.str(
                  'p',
                    ...
                    IE.jsx.str(
                      ...
                      IE.jsx.str(
                        ...
                        IE.jsx.str('input', {
                          ...
                          ie_model: aParams.jsx.modelTexteLogin,
                          ie_textbrut: true,
                          type: 'text',
                          ...
                          'aria-label':
                            aParams.traductions.textePlaceholderIdentifiant,
                          ie_attr: aParams.jsx.getAttrLogin,
                        }),
                        IE.jsx.str(
                          'p',
                          {
                      ...
                      IE.jsx.str(
                        ...
                        IE.jsx.str(
                          ...
                          IE.jsx.str('input', {
                            ...
                            ie_model: aParams.jsx.modelTexteMdp,
                            type: 'password',
                            ...
                            'aria-label':
                              aParams.traductions.textePlaceholderMotdepasse,
                            ie_attr: aParams.jsx.getAttrMDP,
                          }),
                          IE.jsx.str(
                            'p',
                            {
                          ...
                          IE.jsx.str(IEHtml_BtnImage_1.BtnIcon, {
                            class: 'icon_eye_open',
                            ie_model: aParams.jsx.montrerMasquerMDP(),
                          }),
                        ),
                      ),
                    ),
                ...
                IE.jsx.str(
                  IEHtml_Bouton_1.Bouton,
                  {
                    ...
                    ie_model: aParams.jsx.modelBoutonValidation(),
                ...
                IE.jsx.str(
                  'div',
                  {
                    ie_display: aParams.jsx.displayBoutonRecuperationMDP(),
                    class: 'recup-mdp',
                  },
                  IE.jsx.str(
                    'button',
          ...
          ' ',
          IE.jsx.str('div', {
            ie_identite: aParams.jsx.identiteFooter,
          ...
          aParams.options.urlImageFond &&
            ...
            IE.jsx.str(
              'div',
              {
                ...
                ie_eventmap: {
                  click: () => $(`#${aParams.id.imageSuite}`).toggle(),
                },
              ...
              IE.jsx.str(
                ...
                aParams.options.avecLienSuite &&
                  ...
                  IE.jsx.str(
                    'a',
                    {
                      ...
                      class:
                        'font-size-m LienLouvre fluid-bloc m-right-l text-right',
                      ie_eventmap: {
                        click: () => $.get(aParams.options.suiviLienSuite),
                      },
                    },
                    aParams.options.texteLienSuite,
                  ),
                aParams.options.lienLogo &&
                  ...
                  IE.jsx.str('a', {
                    ...
                    ie_eventmap: {
                      click: () => $.get(aParams.options.suiviLogo),
                    },
