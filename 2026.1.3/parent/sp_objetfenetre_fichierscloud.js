IE.fModule({
  f: function (exports, require, module, global) {
    ...
    const DonneesListe_FichiersCloud_1 = require('@scolys/espace/script/professeur/DonneesListe/DonneesListe_FichiersCloud');
    ...
    const TypeStatutInterrogationCloud_1 = require('@cp/Espace/Script/Enumeres/TypeStatutInterrogationCloud');
    ...
    const ObjetRequeteCloudAttente_1 = require('@cp/Produit/Script/Requete/ObjetRequeteCloudAttente');
    ...
    require('@scolys/espace/css/ObjetFenetre_FichiersCloud.css');
    class ObjetFenetre_FichiersCloud extends ObjetFenetre_1.ObjetFenetre {
        ...
        this.idListe = this.add(
          ...
          (aInstance) => {
            aInstance.setOptionsListe({
              ...
              boutons: [
                {
                  svg: IE.jsx.str(IconeSvgRefresh_1.IconeSvgRefresh, null),
                  event: () => {
      ...
      jsxGetHtmlFilAriane() {
        const H = [];
        const lTab = this._getTabParentsDIdPartage(
          this.idPartageDossierSelection,
        );
        lTab.forEach((aDossier, aIndex) => {
          H.push(
            IE.jsx.str(
              ...
              {
                ie_model: this.jsxModeleChipsFilAriane.bind(
                  this,
                  aDossier.idPartage,
      ...
      jsxModelBoutonUpload() {
        return {
          ...
          addFiles: (aParams) => {
            this._uploadListeFichiersVersCloud(aParams.listeFichiers);
          },
        };
      }
      getLibelleFenetreBtn(aBouton) {
        if (aBouton.estValider) {
          return this.optionsFenetre.modeSelectionRepertoirePourUpload
            ? DonneesListe_FichiersCloud_1.TradFichiersCloud
      ...
      getDisabledFenetreBtn(aBouton) {
        if (aBouton.estValider && this.param && this.param.racineFichier) {
          let lResult = 0;
          this._parcoursDossiersRacine((aElement) => {
          ...
          .then(() => {
            if (lBouton && lBouton.estValider && this.param.racineFichier) {
              ...
              if (
                ...
                const lJsxRadioFormatPublicationFichierCloud = (
                  aIdPartage,
                  aTypeFormat,
                ) => {
                  return {
                    ...
                    getName: () => {
                      return 'jsxRadioFormatPublicationFichierCloud';
                    },
                  };
                };
                return GApplication.getMessage()
                  .afficher({
                    ...
                    message: this._composeMessage(
                      lListePubPDF,
                      lJsxRadioFormatPublicationFichierCloud,
                    ),
                  })
                  .then((aGenreAction) => {
                    if (
          ...
          IE.jsx.str(
            ...
            IE.jsx.str(
              ...
              IE.jsx.str('div', {
                ...
                ie_html: this.jsxGetHtmlFilAriane.bind(this),
              }),
            ),
            IE.jsx.str('div', {
              ...
              ? IE.estMobile
                ? IE.jsx.str(
                    IEHtml_Bouton_1.Bouton,
                    {
                      ...
                      ie_model: this.jsxModelBoutonUpload.bind(this),
                      ie_selecfile: true,
                      ie_class: this.jsxGetClassBoutonUpload.bind(this),
                    },
                    DonneesListe_FichiersCloud_1.TradFichiersCloud
                      .Deposer_Cloud,
                  )
      ...
      _composeMessage(aListeFichiers, aJsxModelRadioFormatPublication) {
        const H = [];
        H.push(
          '<div class="Gras">',
          DonneesListe_FichiersCloud_1.TradFichiersCloud
          ...
          H.push(
            IE.jsx.str(
              ...
              IE.jsx.str(
                ...
                {
                  ie_model: aJsxModelRadioFormatPublication.bind(
                    this,
                    aEle.idPartage,
                    TTypeElementCloud_1.TypeFormatPublication.FP_Natif,
                  ),
