  ...
  f: function (exports, require, module, global) {
    ...
    class ObjetMoteurConnexion {
      constructor() {
        ...
        const lNomProduit = this.application.nomProduitSysteme;
        this.const = {
          Cookie_Identification: lNomProduit + '_Identification',
          Cookie_Authentification: lNomProduit + '_Authentification',
          Cookie_Espace: lNomProduit + '_Espace',
          Cookie_estCAS: lNomProduit + '_EstCas',
        };
        this.reset(true);
      }
      reset(aFull = false) {
      ...
      setTokenSAV(aToken) {
        let lMsg = forge.random.getBytesSync(
