IE.fModule({
  f: function (exports, require, module, global) {
    ...
    const ObjetFenetre_SelectionClouds_1 = require('@scolys/espace/script/ObjetFenetre_SelectionClouds');
            ...
            ObjetFenetre_FichiersCloud_1.ObjetFenetre_FichiersCloud,
            {
              ...
              initialiser(aFenetre) {
                if (aParams.optionsFenetre) {
                  aFenetre.setOptionsFenetre(aParams.optionsFenetre);
                }
              },
            },
                ...
                if (aLigne >= 0) {
                  ...
                  const lResult =
                    await exports.UtilitaireGestionCloudEtPDF.ouvrirFenetreChoixFichierCloud(
                      {
                        service: lService,
                        instance: lParams.instance || {},
                        optionsFenetre: lParams.optionFenetreFichiersCloud,
                      },
                    );
                  aResolve(lResult);
                }
