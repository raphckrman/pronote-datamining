IE.fModule({
  f: function (exports, require, module, global) {
    ...
    const ObjetChoixStrategieSecurisation_1 = require('@cp/Produit/Script/ObjetChoixStrategieSecurisation');
    const ObjetSaisieCodePIN_1 = require('@cp/Espace/Script/ObjetSaisieCodePIN');
    ...
    const ObjetFenetre_SaisieMdpCP_1 = require('@cp/Espace/Script/Fenetres/ObjetFenetre_SaisieMdpCP');
      ...
      static async suivant(aDonnees, aResultSecu, aChaineEtape) {
        ...
        switch (aChaineEtape.etape) {
          case Etape.choixStrat: {
            ...
            if (
              (_a =
                lResultFenetre === null || lResultFenetre === void 0
                  ? void 0
                  : lResultFenetre.bouton) === null || _a === void 0
                ? void 0
                : _a.valider
            ) {
          ...
          case Etape.PIN: {
            ...
            if (
              lResultFenetrePIN === null || lResultFenetrePIN === void 0
                ? void 0
                : lResultFenetrePIN.paramsPIN
            ) {
          ...
          case Etape.enregistrement: {
            ...
            if (
              lResultFenetreEnregistrement === null ||
              lResultFenetreEnregistrement === void 0
                ? void 0
      ...
      compose() {
        ...
        return IE.jsx.str(
          ...
          IE.jsx.str(
            ...
            {
              id: lIdCB,
              ie_model: this.jsxModeleCheckboxIdentification.bind(this),
              class: 'm-bottom-xl',
            },
            TraductionsDoubleAuth_1.TradDoubleAuth
          ...
          IE.jsx.str(
            ...
            IE.jsx.str('input', {
              type: 'text',
              id: this.idInput,
              ie_model: this.jsxModeleInputIdentification.bind(this),
              class: 'full-width',
            ...
            IE.jsx.str('div', {
              ie_html: this.jsxGetHtmlCompteurInput.bind(this),
