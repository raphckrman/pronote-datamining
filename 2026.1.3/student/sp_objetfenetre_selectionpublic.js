IE.fModule({
  f: function (exports, require, module, global) {
    ...
    const ObjetFenetre_SelectionRessource_1 = require('@cp/Produit/Script/ObjetFenetre_SelectionRessource');
    ...
    const DonneesListe_SelectionPublic_1 = require('@cp/Produit/Script/DonneesListe_SelectionPublic');
    ...
    (function (TypeGenreCumulSelectionPublic) {
      ...
      TypeGenreCumulSelectionPublic[
        (TypeGenreCumulSelectionPublic['regime'] = 15)
      ] = 'regime';
      TypeGenreCumulSelectionPublic[
        (TypeGenreCumulSelectionPublic['autorisationsDeSortie'] = 16)
      ] = 'autorisationsDeSortie';
      TypeGenreCumulSelectionPublic[
        (TypeGenreCumulSelectionPublic['regimeEleve'] = 17)
      ] = 'regimeEleve';
      TypeGenreCumulSelectionPublic[
        (TypeGenreCumulSelectionPublic['autorisationsDeSortieEleve'] = 18)
      ] = 'autorisationsDeSortieEleve';
    })(
      TypeGenreCumulSelectionPublic ||
    ...
    class ObjetFenetre_SelectionPublic extends ObjetFenetre_SelectionRessource_1.ObjetFenetre_SelectionRessource {
        ...
        return {
          ...
          event: (aParams) => {
            if (
              ...
              this.setCumulActif(aParams.element);
      ...
      composeContenu() {
        ...
        return IE.jsx.str(
          ...
          IE.jsx.str('div', {
            ...
            style: { display: 'none', backgroundColor: 'var(--couleurFond)' },
          }),
          IE.jsx.str(
            'div',
            {
              ...
              style: { backgroundColor: 'var(--couleurFond)' },
            },
            IE.jsx.str(IEHtml_Combo_1.Combo, {
              ie_model: this.jsxComboModelCumul.bind(this),
      ...
      actualiserAffichage() {
        switch (this.getGenreCumul()) {
          ...
          case TypeGenreCumulSelectionPublic.nomElevesGroupe:
            ...
            break;
          case TypeGenreCumulSelectionPublic.regime:
            this._construireListeRessourceAvecCumulRegime(
              this.listeRessourcesT,
              this.listeRessourcesSelectionnees,
            );
            break;
          case TypeGenreCumulSelectionPublic.regimeEleve:
            this._construireListeRessourceAvecCumulRegimeEleve(
              this.listeRessourcesT,
              this.listeRessourcesSelectionnees,
            );
            break;
          case TypeGenreCumulSelectionPublic.autorisationsDeSortie:
            this._construireListeRessourceAvecCumulAutorisationsDeSortie(
              this.listeRessourcesT,
              this.listeRessourcesSelectionnees,
            );
            break;
          case TypeGenreCumulSelectionPublic.autorisationsDeSortieEleve:
            this._construireListeRessourceAvecCumulAutorisationsDeSortieEleve(
              this.listeRessourcesT,
              this.listeRessourcesSelectionnees,
            );
            break;
      ...
      _construireListeRessourceAvecCumulClasse(
        ...
        const lAjouterRessourceALaListe = (aRessource, aPere) => {
          ...
          if (lMaRessource.eleves) {
            const lEleveConcerneParLaClasse =
              lMaRessource.eleves.getElementParFiltre((aEleve) => {
                var _a;
                return (
                  ((_a = aEleve.classe) === null || _a === void 0
                    ? void 0
                    : _a.getNumero()) === aPere.getNumero()
                );
              });
            if (
              lEleveConcerneParLaClasse === null ||
              lEleveConcerneParLaClasse === void 0
                ? void 0
                : lEleveConcerneParLaClasse.niveauResponsabilite
            ) {
              lMaRessource.niveauResponsabilite =
                lEleveConcerneParLaClasse.niveauResponsabilite;
            }
          }
          ...
          if (aListeRessources.get(i).existeNumero()) {
            ...
            if (!lRessource.groupes || lRessource.groupes.count() === 0) {
              ...
              for (
                ...
                if (lMaRessource.eleves) {
                  const lEleveConcerneParLeGroupe =
                    lMaRessource.eleves.getElementParFiltre((aEleve) => {
                      var _a;
                      return (_a = aEleve.groupes) === null || _a === void 0
                        ? void 0
                        : _a.getTableauNumeros().includes(lNiveau.getNumero());
                    });
                  if (
                    lEleveConcerneParLeGroupe === null ||
                    lEleveConcerneParLeGroupe === void 0
                      ? void 0
                      : lEleveConcerneParLeGroupe.niveauResponsabilite
                  ) {
                    lMaRessource.niveauResponsabilite =
                      lEleveConcerneParLeGroupe.niveauResponsabilite;
                  }
