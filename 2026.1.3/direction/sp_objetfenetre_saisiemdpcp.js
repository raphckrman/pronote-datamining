IE.fModule({
  f: function (exports, require, module, global) {
    ...
    const ObjetSaisieMotDePasseCP_1 = require('@cp/Produit/Script/ObjetSaisieMotDePasseCP');
    ...
    class ObjetFenetre_SaisieMdpCP extends ObjetFenetre_1.ObjetFenetre {
      ...
      getDisabledFenetreBtn(aBouton) {
        return aBouton.valider
          ? !this.getInstance(this.identMDP).avecValidationPossible()
          : false;
      }
