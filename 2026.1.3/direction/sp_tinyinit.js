IE.fModule({
  f: function (exports, require, module, global) {
    ...
    require('@cp/tiny/TinyIndex.css');
    class ObjetTinyInit {
      constructor() {
        this.optionsInitTiny = {
          avecMessageNettoyageHtml: true,
          optionsDOMPurify: undefined,
        };
        this.plugins = [
          'autolink',
          'charmap',
        ...
        if (lParam.filePickerOpener && lParam.filePickerTypes) {
          ...
          lParam.filePickerReturn = function (aUrl) {
            ...
            if (lEditor) {
              ...
              lEditor.callbackFilePicker = undefined;
            }
        ...
        return this.plugins
          .concat(
            ...
            aParam &&
              ...
              (((_a = aParam.filePickerTypes) === null || _a === void 0
                ? void 0
                : _a.indexOf('image')) || 0) > -1
              ? ['image']
              : [],
      ...
      supprimerImageEtVide(aSurGetContent, ed) {
        ...
        if (
          ...
          (_b = (_a = this.optionsInitTiny).afficherMessage) === null ||
          _b === void 0
            ? void 0
            : _b.call(_a, this.genreMessage.imageInterdite);
        }
      ...
      _detruireInstanceTiny(aTinymce, aID) {
        ...
        if (lInstanceTiny) {
          ...
          try {
            ...
            $('#' + aID.escapeJQ()).focus();
            try {
              (_a = aTinymce.get(aID)) === null || _a === void 0
                ? void 0
                : _a.destroy();
            } catch (e) {}
            $('#' + aID.escapeJQ()).focus();
