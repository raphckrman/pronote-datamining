    ...
    class ObjetPosition {
      ...
      getRect(aId, aPositionAbsolue) {
        ...
        if (lElement && lElement.getBoundingClientRect) {
          ...
          if (lBoundingRect) {
            ...
            lRect.visible = lElement.checkVisibility
              ? ((_a = lElement.checkVisibility) === null || _a === void 0
                  ? void 0
                  : _a.call(lElement)) === true
              : !(
                  lRect.top === 0 &&
                  lRect.left === 0 &&
                  lRect.height === 0 &&
      ...
      placer(aId, aLeft, aTop, aEcartBordEcran) {
        ...
        if (lY2 + lEcartBordEcran.y > this.navigateur.ecranH) {
          lY1 =
            this.navigateur.ecranH - this.getHeight(aId) - lEcartBordEcran.y;
        }
        this.setPosition(
          aId,
      ...
      placerFicheSource(
        ...
        const lVisible =
            aVisible === null || aVisible === undefined
              ? ((_a = ObjetHtml_1.GHtml.getElement(aId)) === null ||
                _a === void 0
                  ? void 0
      ...
      getPositionEventJQuery(aEvent) {
        ...
        if (aEvent.pageX !== undefined) {
          return {
            ...
            y: Math.round(
              (_a = aEvent.pageY) !== null && _a !== void 0 ? _a : 0,
            ),
          };
        }
      ...
      _modifierPositionSiChevauchement(aPositionMobile, aPositionSource) {
        if (
          aPositionMobile.x + aPositionMobile.width >
          this.navigateur.ecranL
        ) {
          aPositionMobile.x = this.navigateur.ecranL - aPositionMobile.width;
        }
        if (
          aPositionMobile.y + aPositionMobile.height >
          this.navigateur.ecranH
        ) {
