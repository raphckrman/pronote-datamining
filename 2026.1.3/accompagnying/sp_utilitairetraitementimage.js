  ...
  f: function (exports, require, module, global) {
    ...
    const UtilitaireTraitementImage = {
      ...
      resizeEtOrientationImgToCanvas(aParams) {
        ...
        const lWidth = lParams.widthResize || lParams.width || 0;
      ...
      resizeFilePromise(aFile, aMaxWidth, aMaxHeight, aCompression) {
        return UtilitaireTraitementImage.fileToImgPromise(aFile)
          .then((aParamsFileToPromise) => {
            ...
            if (lResult.avecResize && lResult.canvas && aFile) {
      ...
      async genererPdfAsync(aListeFichiers) {
        const loadingJspdf = (0, AccessApp_1.getApp)().getGeneric('lib-jspdf');
        if (!loadingJspdf) {
          throw { erreurLib: true };
        }
        const lClassJspdf = await loadingJspdf();
        if (!lClassJspdf) {
          throw { erreurLib: true };
        }
        return Promise.resolve()
                  ...
                  UtilitaireTraitementImage.fileToDataUrlPromise(
                    ...
                    ((aIndex, aDataUrl) => {
                      ...
                      lFilesDataUrl[aIndex] = {
                        ...
                        type:
                          (_b =
                            (_a = lFichier.file) === null || _a === void 0
                              ? void 0
      ...
      estEnBase64(aURL) {
        ...
        return (
          ((_b =
            (_a = aURL.match(/data:[a-zA-Z/]*;base64,/)) === null ||
            _a === void 0
              ? void 0
