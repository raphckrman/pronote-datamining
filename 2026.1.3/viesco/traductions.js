IE.fModule({
  f: function (exports, require, module, global) {
    ...
    module.exports.trad = function (a) {
      ...
      a('Demo.Identifiant', 'demonstration2');
      ...
      a(
        ...
        'https://swie.index-education.com/redirect.php?produit=pn&page=comment-renforcer-securite&version=2026.1.3.0&distrib=FR&lg=fr&flag=Espace_Etablissement&type=LienDocProduit',
      );
      a(
        'AvertissementDemo',
      ...
      a('$GlossaireSuiviJustificationAbsRet', (b) => {
        a(`${b}.AouR`, 'A ou R');
        a(`${b}.absenceOuRetard`, 'Absence ou retard');
        a(`${b}.nomEleve`, 'Nom');
        a(`${b}.classe`, 'Classe');
        a(`${b}.regime`, 'Régime');
        a(`${b}.dureeRetard`, 'Durée');
        a(
          `${b}.hintDureeRetard`,
          "Durée du retard ou du passage à l'infirmerie",
        );
        a(`${b}.date`, 'Date');
        a(`${b}.motif`, 'Motif');
        a(`${b}.champsObligatoires`, '*Champs Obligatoires');
        a(`${b}.etatJustification`, 'Etat de justification');
        a(`${b}.hintAcceptee`, 'Justification acceptée par la vie scolaire');
        a(`${b}.hintRefusee`, 'Justification rejetée par la vie scolaire');
        a(
          `${b}.hintEnAttenteVS`,
          'Justification envoyée par le responsable, en attente de traitement par la vie scolaire',
        );
        a(
          `${b}.hintEnAttenteParent`,
          'En attente de complément du responsable',
        );
        a(
          `${b}.hintEnAttenteComplementVS`,
          'Complément envoyé par le responsable, en attente de traitement par la vie scolaire',
        );
        a(`${b}.justificationParents`, 'Justification donnée par les parents');
        a(`${b}.justificatifParents`, 'Justificatif fourni par les parents');
        a(`${b}.justificatif`, 'Justificatif');
        a(`${b}.raisonDonneeParents`, 'Raison donnée par les parents');
        a(`${b}.commentaireParents`, 'Commentaire');
        a(
          `${b}.hintCommentaireParents`,
          "Commentaire saisi depuis l'Espace Parents",
        );
        a(`${b}.dateJustificationParents`, 'Date');
        a(
          `${b}.hintDateJustificationParents`,
          "Date de justification dans l'Espace Parents",
        );
        a(`${b}.actionEtablissement`, "Action de l'établissement");
        a(`${b}.acceptee`, 'Acceptée');
        a(`${b}.rejetee`, 'Rejetée');
        a(`${b}.accepter`, 'Accepter');
        a(`${b}.rejeter`, 'Rejeter');
        a(`${b}.justifiePar`, 'Justifié par');
        a(`${b}.demanderAuResponsable`, 'Demander au responsable');
        a(`${b}.complement`, 'Complément');
        a(`${b}.commentaire`, 'Commentaire');
        a(`${b}.aCompleter`, 'A compléter');
        a(
          `${b}.hintACompleter`,
          'Permet de demander une précision du responsable',
        );
        a(
          `${b}.infoPreciserComplement`,
          "Précisez la raison de cette demande de complément d'information au responsable, qui sera visible depuis son Espace Responsable (exemple : La pièce jointe est illisible)",
        );
        a(
          `${b}.titreModaleComplement`,
          "Demande d'informations complémentaires aux responsables",
        );
        a(`${b}.dureeAbsenceCours`, 'Heures Cours');
        a(`${b}.hintDureeAbsenceCours`, "Nombre d'heures de cours manquées");
        a(`${b}.matieresAffectees`, 'Matière');
        a(`${b}.estOuvert`, 'Ouverte');
        a(`${b}.hintEstOuvert`, 'Absence ouverte');
        a(`${b}.demiJourneesBulletin`, '1/2j. Bul.');
        a(
          `${b}.hintDemiJourneesBulletin`,
          "Nombre de demi-journées bulletin d'absence",
        );
        a(`${b}.justifie`, 'Justifiée');
        a(`${b}.regleAdministrativement`, 'RA');
        a(`${b}.hintRegleAdministrativement`, 'Réglée administrativement');
        a(`${b}.suivi`, 'Suivi');
        a(`${b}.filtreNonRA`, 'Uniquement les non reglés administrativement');
        a(`${b}.oui`, 'Oui');
        a(`${b}.non`, 'Non');
        a(`${b}.justificationAcceptee`, 'ACCEPTÉE');
        a(`${b}.hintAbsenceOuverte`, 'Absence ouverte');
        a(`${b}.pieceJointeConsulter`, 'Consulter');
        a(`${b}.pieceJointeRemplacer`, 'Remplacer');
        a(`${b}.pieceJointeSupprimer`, 'Supprimer');
        a(
          `${b}.confirmationEcrasementMotif`,
          'Un motif est déjà rempli et va être écrasé. Confirmez-vous ?',
        );
        a(
          `${b}.confirmationAnnulationTraitementJustification`,
          "Confirmez-vous l'annulation du traitement de la justification sélectionnée ?",
        );
        a(
          `${b}.confirmationAnnulationDemandeComplement`,
          "Confirmez-vous l'annulation de la demande de complément ?",
        );
        a(`${b}.absence`, (b) => {
          a(
            `${b}.confirmationRejet`,
            "Confirmez-vous le rejet de la justification d'absence du responsable ?",
          );
          a(
            `${b}.infoRejet`,
            "Si vous confirmez, cette justification d'absence sera rejetée et réglée administrativement.",
          );
          a(
            `${b}.confirmationAccept`,
            "Confirmez-vous l'acceptation de la justification d'absence du responsable ?",
          );
          a(
            `${b}.infoAccept`,
            "Si vous confirmez, le motif actuel va être remplacé par celui donné par le responsable,\nCette justification d'absence sera acceptée et réglée administrativement.",
          );
          a(
            `${b}.infoAcceptSansMotif`,
            "Si vous confirmez, cette justification d'absence sera acceptée et réglée administrativement.",
          );
          a(
            `${b}.hintTraiteeVS`,
            "L'absence a été régularisée mais aucune action n'a été prise",
          );
        });
        a(`${b}.retard`, (b) => {
          a(
            `${b}.hintTraiteeVS`,
            "Le retard a été régularisé mais aucune action n'a été prise",
          );
          a(
            `${b}.confirmationRejet`,
            'Confirmez-vous le rejet de la justification de retard du responsable ?',
          );
          a(
            `${b}.infoRejet`,
            'Si vous confirmez, la justification de retard sera rejetée et traitée administrativement.',
          );
          a(
            `${b}.confirmationAccept`,
            "Confirmez-vous l'acceptation de la justification de retard du responsable ?",
          );
          a(
            `${b}.infoAccept`,
            'Si vous confirmez, le motif actuel sera remplacé par celui communiqué par le responsable,\nCette justification de retard sera acceptée et réglée administrativement.',
          );
          a(
            `${b}.infoAcceptSansMotif`,
            'Si vous confirmez, cette justification de retard sera acceptée et réglée administrativement.',
          );
        });
        a(`${b}.infoEleve`, "Pour l'élève : %s - %s%s%s");
        a(`${b}.choixMotifDefaut`, 'En conservant le motif :');
        a(`${b}.choixMotifSelect`, 'En affectant le motif suivant :');
      });
      a('$GlossaireWAI', (b) => {
        a(`${b}.heures`, 'heures');
        a(`${b}.colonne`, 'colonne');
