IE.fModule({
  f: function (exports, require, module, global) {
    ...
    require('@cp/Espace/Css/ObjetSaisieCodePIN.css');
    const ObjetIdentite_1 = require('@cp/script/ObjetIdentite');
    const ObjetTraduction_1 = require('@cp/script/ObjetTraduction');
    const SecurisationCompte = tslib_1.__importStar(
      require('@cp/Produit/Script/Type/TypeSecurisationCompte'),
    );
    ...
    const ObjetRequeteSecurisationCompte_1 = require('@cp/Produit/Script/Requete/ObjetRequeteSecurisationCompte');
    ...
    class ObjetSaisieCodePIN extends ObjetIdentite_1.Identite {
      constructor(aParams) {
        ...
        this.parametres = lApplication.getObjetParametres();
        this.etatUtilisateurCP = lApplication.getEtatUtilisateur();
        this.options = {
          classeRequete: null,
      ...
      jsxIfAvecBoutons(aEtape) {
        return this.codePin.etapeConfirmation === aEtape;
      }
      jsxModelBoutonVal(aVal, aEtape) {
        return {
          event: () => {
            switch (aEtape) {
              case TypeEtape.val:
                this.codePin.val += aVal;
                break;
              case TypeEtape.confirm:
                this.codePin.confirm += aVal;
                break;
              case TypeEtape.controlePINOuReinit: {
                this.codePin.valControlePIN += aVal;
                break;
              }
              default:
            }
            const lNb = this.getNbPIN(aEtape);
            if (lNb > 0 && this.getCodePINDEtape(aEtape).length >= lNb) {
              if (this._getDisabled(aEtape)) {
                return;
              }
              this._surValider();
            }
          ...
          node: (aNode) => {
            $(aNode).on('keyup', (aEvent) => {
              if (aEvent.which === ToucheClavier_1.ToucheClavier.Backspace) {
                this.clearBtn(aEtape);
                this.$refresh();
              }
            });
          },
          getDisabled: () => {
            return this._getDisabled(aEtape);
          },
        };
      }
      jsxModelBoutonClear(aEtape) {
        return {
          event: () => {
            this.clearBtn(aEtape);
          },
          getDisabled: () => {
            return this._getDisabled(aEtape, true);
          },
        };
      }
      jsxModelBoutonValider(aEtape) {
        return {
          event: () => {
            this._surValider();
          },
          getDisabled: () => {
            ...
            if (
              this.getCodePINDEtape(aEtape).length <
      ...
      jsxModelBoutonPINOubli() {
        return {
          event: async () => {
            const lJSONReponse = await new this.options.classeRequete(
              this,
            ).lancerRequete({
              action:
            ...
            const lResultFenetre =
              await ObjetFenetre_1.ObjetFenetre.creerInstanceFenetre(
                ...
                { pere: this },
              ).afficher(this.options.emailOcculte);
            if (lResultFenetre && lResultFenetre.resultReinitPIN) {
              if (lResultFenetre.resultReinitPIN.reinitPIN_OK) {
                this.callback.appel(lResultFenetre.resultReinitPIN);
              }
            }
          },
        };
      }
      jsxGetHtmlMessagePin() {
        return this._construireMessagePINVerification();
      }
      setDonnees(aDonnees) {
      ...
      jsxGetHtmlAlertControleInitialPIN() {
        if (this.codePin.saisiePinVerifie) {
        ...
        return IE.jsx.str(
          ...
          IE.jsx.str(
              ...
              if (lReinitPIN || lControlerModifierPIN) {
                ...
                return IE.jsx.str(
                  ...
                  IE.jsx.str('span', {
                    class: 'sr-only',
                    role: 'alert',
                    ie_html: this.jsxGetHtmlAlertControleInitialPIN.bind(this),
                  }),
                );
              }
              return '';
            ...
            IE.jsx.str(
              ...
              lControlePIN
                ? IE.jsx.str('div', {
                    ie_html: this.jsxGetHtmlMessagePin.bind(this),
          ...
          () => {
            if (
              this.parametres.urlFAQEnregistrementDoubleAuth &&
              ...
              return IE.jsx.str(
                IEHtml_Chips_1.Chips,
                {
                  ...
                  href: this.parametres.urlFAQEnregistrementDoubleAuth,
                },
      ...
      getNbPIN(aEtape) {
        ...
        return this.etatUtilisateurCP.getCodePINFixe()
      ...
      jsxGetClassVisuPIN(aEtape) {
        return this.codePin.etapeConfirmation === aEtape ? 'active' : '';
      }
      jsxGetClassConteneurVisuPIN(aEtape) {
        return this.codePin.etapeConfirmation !== aEtape ? 'disabled' : '';
      }
      jsxGetHtmlVisuPIN(aEtape, aNbPIN) {
        let lNbSaisie = this.getCodePINDEtape(aEtape).length;
        if (aNbPIN > 0) {
          let lResult = '';
      ...
      construireVisuCode(aEtape) {
        ...
        return IE.jsx.str(
          'div',
          {
            class: 'scp-visu-pin',
            'aria-hidden': 'true',
            ie_class: this.jsxGetClassConteneurVisuPIN.bind(this, aEtape),
          },
          ...
          IE.jsx.str(
            ...
            IE.jsx.str('span', {
              ie_html: this.jsxGetHtmlVisuPIN.bind(this, aEtape, lNbPIN),
              ie_class: this.jsxGetClassVisuPIN.bind(this, aEtape),
            }),
          ),
        );
      }
      construireClavier(aEtape) {
        ...
        return IE.jsx.str(
          'ul',
          {
            ...
            ie_if: this.jsxIfAvecBoutons.bind(this, aEtape),
          },
          (aTab) => {
            const lTab = [];
            for (let i = 0; i < 10; i++) {
                ...
                IE.jsx.str(
                  ...
                  IE.jsx.str(
                    IEHtml_Bouton_1.Bouton,
                    {
                      ...
                      ie_model: this.jsxModelBoutonVal.bind(this, lVal, aEtape),
                    },
                    lVal,
                  ),
                ),
              ...
              IE.jsx.str(
                ...
                IE.jsx.str(
                  ...
                  IE.jsx.str(
                    ...
                    {
                      class: 'themeBoutonNeutre',
                      ie_model: this.jsxModelBoutonClear.bind(this, aEtape),
                  ...
                  ? IE.jsx.str(
                      ...
                      IE.jsx.str(
                        IEHtml_Bouton_1.Bouton,
                        {
                          ...
                          ie_model: this.jsxModelBoutonValider.bind(
                            this,
                            aEtape,
                          ),
                        },
                ...
                IE.jsx.str(
                  ...
                  IE.jsx.str(
                    IEHtml_Bouton_1.Bouton,
                    {
                      ...
                      ie_model: this.jsxModelBoutonPINOubli.bind(this),
                      title:
                        TraductionsDoubleAuth_1.TradDoubleAuth
