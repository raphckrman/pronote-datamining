  ...
  f: function (exports, require, module, global) {
    ...
    class ObjetListeElements {
      ...
      remove(aIndexOuTabIndex) {
        if (
          aIndexOuTabIndex !== null &&
          aIndexOuTabIndex !== undefined &&
          aIndexOuTabIndex >= 0 &&
      ...
      getLibelle(I) {
        ...
        var _b;
        return (_b =
          (_a = this.ListeElements[I]) === null || _a === void 0
            ? void 0
            : _a.Libelle) !== null && _b !== void 0
          ? _b
          : '';
      }
      getActif(I) {
      ...
      trier(aGenreTri) {
        if (this.ListeElements) {
          ...
          const lTris = this._tris !== null ? [...this._tris] : [];
          lTris.unshift(
