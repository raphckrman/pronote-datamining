IE.fModule({
  f: function (exports, require, module, global) {
    ...
    module.exports.trad = function (a) {
      ...
      a(
        'fenetre_ActionContextuelle.parmiDocsDejaUtilises',
      ...
      a(
        'fenetre_ActionContextuelle.depuisManuelNumerique',
        'Depuis un manuel numérique',
      );
      a(
        'fenetre_ActionContextuelle.parmiQCMDeRevision',
        'Parmi les QCM de révision',
      );
      a(
        'fenetre_ActionContextuelle.parmiLiensDejaUtilises',
      ...
      a(
        'BandeauEntete.RaccourcisDetails',
      ...
      a(
        ...
        "L'élève n'a pas pu participer à ce devoir : il n'était pas dans cette classe ou ce groupe à la date du devoir",
      );
      a(
        'PageNotes.ElevePasDansPeriode',
        "Le devoir n'est pas comptabilisé sur la période sélectionnée pour cet élève.",
      );
      ...
      a(
        ...
        "Destinataires ayant accusé réception de l'information",
      );
      a(
        'infoSond.labelListeResultatSondage',
        'Réponses des destinataires du sondage à la question %s',
      );
      a('infoSond.labelChxUniq', 'Choix unique pour la question %s');
      a('infoSond.labelChxMulti', 'Choix multiple pour la question %s');
      a(
        'infoSond.labelSondAnonyme',
        'Choix du type de sondage : nominatif ou anonyme',
      );
      a(
        'infoSond.labelGenreDestParEntite',
        'Choix multiple des genres de destinataires liés aux promotions/regroupements',
      );
      a(
        'infoSond.labelGenreEnvoiDestParent',
        "Choix du type d'envoi pour les destinataires de type parents : par parent ou par étudiant",
      );
      a(
        'infoSond.labelChxEntites',
        'Choix des promotions/regroupements pour la sélection des destinataires liés aux promotions/regroupements',
      );
      a(
        'infoSond.labelChxIndividus',
        'Choix des destinataires à titre individuels, sélectionnables en fonction de leur genre',
      );
      a(
        'infoSond.labelChxTypeReponse',
        'Choix du type de réponse : à saisir, choix unique ou choix multiple',
      );
      a(
        'infoSond.labelChxDestPartageResult',
        'Choix des destinataires pour le partage des résultats, sélectionnables en fonction de leur genre',
      );
      a(
        'infoSond.legendChxDestinataires',
        'Destinataires (au moins un destinataire doit obligatoirement être renseigné)',
      );
      a('infoSond.nature', 'Nature');
      a(
        'infoSond.natureVisibleParDest',
        'Nature visible par les destinataires',
      );
      a('infoSond.1MessageNonLu', '1 message non lu');
      a('infoSond.XMessagesNonLus_D', '%d messages non lus');
      a(
        'infoSond.sondageAnonymeOuvreEntreLeEtle',
        'Sondage anonyme ouvert entre le %s et le %s',
      );
      a(
        'infoSond.sondageNominatifOuvreEntreLeEtle',
        'Sondage nominatif ouvert entre le %s et le %s',
      );
      ...
      a(
        'fenetreRecupIdMDP.titre',
        'Récupérer votre identifiant / mot de passe',
      );
      a(
        'fenetreRecupIdMDP.titreCreation',
        "Créer mon compte sur l'Espace Inscription",
      );
      a(
        'fenetreRecupIdMDP.header',
      ...
      a(
        ...
        "(celle que vous avez donnée à l'établissement)",
      );
      ...
      a(
        ...
        'Saisissez votre code de sécurité reçu par e-mail',
      );
      ...
      a(
        ...
        'Nous vous avons envoyé un e-mail avec votre identifiant et un code de sécurité valable pendant 15 minutes et uniquement sur cette page.',
      );
      a('fenetreRecupIdMDP.stage2_ko_titre', 'Récupération impossible');
      a(
        'fenetreRecupIdMDP.stage2_ko_multi',
        "L'adresse e-mail renseignée est associée à plusieurs comptes.",
      );
      a(
      ...
      a(
        ...
        "L'adresse e-mail renseignée n'a pas été trouvée.",
      );
      a(
        'fenetreRecupIdMDP.stage2_ko_zero2',
        "Contactez le responsable de votre établissement afin d'obtenir vos identifiants.",
      );
      a(
      ...
      a(
        ...
        'Pour vous y connecter veuillez cliquer sur le bouton "Vous avez déjà une inscription en cours".',
      );
      a(
        'fenetreRecupIdMDP.stage2_ko_creation3',
        'Si vous avez oublié le mot de passe associé à ce compte, cliquez sur "Récupérer votre mot de passe" dans la fenêtre de connexion.',
      );
      ...
      a(
        ...
        "Vous pouvez vous connecter à l'Espace Inscription en utilisant votre adresse e-mail comme identifiant.",
      );
      a(
      ...
      a(
        ...
        "Le code de sécurité, indispensable à l'étape 2, a été envoyé à l'adresse mail saisie ci-dessus.",
      );
      ...
      a(
        ...
        "la récupération de votre identifiant / mot de passe n'est pas possible en mode consultation",
      );
      ...
      a(
        'FicheStageCP.SelectionRubriqueFicheStage',
        'Sélectionnez une rubrique de la fiche de stage',
      );
      ...
      a(
        'FicheStageCP.ConvetionDeStageEnCours',
        'Convention de stage (signature électronique en cours)',
      );
      a(
        'FicheStageCP.ConventionSigneePar',
        'Convention signée par %s signataires',
      );
      a(
        'FicheStageCP.ConventionSigneeElectroniquementPar',
        'Convention signée électroniquement par %s signataires',
      );
      ...
      a(
        ...
        "PRONOTE propose d'optimiser vos pièces jointes : compression, transformation PDF, ...",
      );
      a(
        'TransformationFlux.PropositionCibleCloud_S',
        "Seul le dépôt au travers d'un cloud %s est possible",
      );
      a(
        'TransformationFlux.FichierOriginalTransferable',
        'Le fichier original peut être transféré directement vers PRONOTE.',
      );
      ...
      a(
        'FenetreParamExecutionQCM.RedonnerQuestionsFausses',
        'Réponses mauvaises / partielles rejouées',
      );
      ...
      a(
        'Onglet.LibelleLong',
        'Récapitulatif des évènements de la vie scolaire',
      );
      ...
      a('Classes', 'Classes');
      a('ClassesSelectionnees', 'classe(s) sélectionée(s)');
      a('Groupes', 'Groupes');
      a('GroupesSelectionnes', 'groupe(s) seélectionné(s)');
      a('Parties', 'Parties');
      a('Salles', 'Salles');
      a('Niveau', 'Niveau');
      a('Nom', 'Nom');
      ...
      a('TousLesRegimes', 'Tous les regimes');
      a('RegimeSur', 'regime(s) sur');
      ...
      a('SelectionIndividus', 'Selectionner des individus');
      ...
      a('SelectionAuteurs', 'Selectionner des auteurs');
      a('SelectionTemoins', 'Selectionner des témoins');
      a('SelectionVictimes', 'Selectionner des victimes');
      ...
      a(
        ...
        'Sélectionner la partie de journée.',
      );
      a(
        'WAI.SelectionSessionRencontre',
        'Sélectionner une session de rencontres',
      );
      ...
      a(
        ...
        'Sélectionner une classe, un groupe ou un niveau',
      );
      ...
      a(
        ...
        'Menu déroulant : Sélectionner une classe ou un groupe :',
      );
      ...
      a(
        'SelectionnerEquipePedagogique',
        'Sélectionner des équipes pédagogiques',
      );
      ...
      a(
        'Fenetre_SelectionRessource.autorisationSortieDesEleves',
        'Autorisation de sortie des élèves',
      );
      a(
        'Fenetre_SelectionRessource.sansAutorisationSortie',
        'Sans autorisation de sortie',
      );
      a(
        'Fenetre_SelectionRessource.regimeDemiPension',
        'Régime de demi-pension',
      );
      a(
        'Fenetre_SelectionRessource.autorisationSortie',
      ...
      a(
        ...
        'Sélection des élèves sans cours',
      );
      ...
      a(
        ...
        'Usager des transports scolaires',
      );
      a(
        'Fenetre_SelectionElevesSansCours.PresenceNonObligatoire',
        "Les élèves dont la présence dans l'établissement n'est pas obligatoire (selon leur autorisation de sortie)",
      );
      a(
      ...
      a(
        ...
        'Groupes à effectif variable compatibles (accompagnement personnalisé, devoirs faits, ...)',
      );
      a(
      ...
      a(
        ...
        'Confirmez-vous le retrait de %s du groupe %s entre le %s et le %s ?',
      );
      a(
      ...
      a(
        ...
        'Proposition en attente de votre choix',
      );
      ...
      a(
        ...
        "Ne plus me porter volontaire<br />Vous vous êtes porté volontaire.<br />En validant l'annulation de votre demande, vous retirez votre demande de remplacement, cependant un administrateur pourra tout de même vous attribuer celui-ci.",
      );
      ...
      a(
        'RemplacementsEnseignants.volontaire.titleCommentaire',
        'Commentaire du volontariat',
      );
      a(
      ...
      a(
        ...
        'Raison du volontariat par exemple',
      );
      ...
      a(
        ...
        'Uniquement les cours qui me concernent (mes matières ou mes classes)',
      );
      a(
        'RemplacementsEnseignants.UniquementSiDisponible',
        'Uniquement les cours si je suis disponible',
      );
      ...
      a(
        ...
        "Afficher uniquement les élèves présent dans l'établissement lors de l'année en cours",
      );
      a(
        'LienPolitiqueMotDePasse.UrlFAQMotDePasse',
        'https://swie.index-education.com/redirect.php?produit=pn&page=comment-renforcer-securite&version=2026.1.3.0&distrib=FR&lg=fr&flag=Espace_Professeur&type=LienDocProduit',
      );
      a(
        'AvertissementDemo',
      ...
      a(
        ...
        'Sauvegarder mes QCM, progressions et appréciations dans un fichier',
      );
      a(
        'Commande.RecupererFichierDeRessources',
        'Récupérer mes QCM, progressions et appréciations depuis une sauvegarde...',
      );
      a(
        'EchecSauvegarderUnFichierDeRessourcesPeda',
        'Echec lors de la sauvegarde de mes données',
      );
      ...
      a(
        ...
        "Les élèves exclus temporairement ou définitivement ou à titre conservatoire de l'établissement, de la classe, de la demi-pension ou de l'internat",
      );
      a(
        'accueil.exclusion.msgAucun',
        'Aucune exclusion (temporaire ou définitive), aucune mesure conservatoire',
      );
      ...
      a(
        ...
        'Afficher la liste des Candidats constitutifs des listes',
      );
      a(
      ...
      a(
        'actualites.messagerieDesactivee',
        'Vous avez temporairement désactivé la réception des informations et sondages',
      );
      a(
        'actualites.recupererMessageDesactivation',
        'Récupérer les informations et sondages non reçus',
      );
      a(
        'actualites.modifierPreferencesDesactivation',
      ...
      a(
        'destinataires.destinatairesAvertissement',
        "Pour chaque classe ou groupe sélectionné, tous les individus concernés seront destinataires y compris ceux ajoutés en cours d'année",
      );
      ...
      a(
        'destinataires.SelectionClassesGroupes',
      ...
      a(
        ...
        'Personnaliser la présentation des items',
      );
      a(
      ...
      a(
        ...
        "Afficher les projets d'accompagnement",
      );
      a(
      ...
      a(
        ...
        'La période « %s » est clôturée pour la saisie des notes.',
      );
      a(
        'evaluations.FenetreSaisieEvaluation.AucunSousServicePourLeDevoir',
        "Aucun sous-service n'est disponible pour créer le devoir",
      );
      a(
        'evaluations.FenetreSaisieEvaluation.DevoirDeLEvaluation',
        "Devoir associé à l'évaluation :",
      );
      a(
        'evaluations.FenetreSaisieEvaluation.DecalageUnJourPublicationParentsSoitLe',
        "Conformément au paramétrage de l'Espace Parents, l'évaluation sera publiée aux parents un jour après la publication aux élèves, soit le %s",
      );
      a(
        'evaluations.FenetreSaisieEvaluation.DecalageXJoursPublicationParentsSoitLe',
        "Conformément au paramétrage de l'Espace Parents, l'évaluation sera publiée aux parents %d jours après la publication aux élèves, soit le %s",
      );
      ...
      a(
        'evaluations.FenetreEvaluationQCM.QCMPourLeService',
        'Pour le service :',
      );
      a(
        'evaluations.FenetreEvaluationQCM.ReponsesEleveEntre',
      ...
      a(
        ...
        "Évolution de l'élève par rapport à la période précédente",
      );
      a(
      ...
      a(
        'releve_evaluations.colonne.hint.ects',
        "Crédits ECTS de l'élève pour le service",
      );
      a(
      ...
      a(
        ...
        "Détermination de la note de l'élève en fonction des résultats obtenus aux évaluations",
      );
      a(
        'releve_evaluations.colonne.hint.btnValidationAutoNivAcquiDomaine',
        'Calcul du niveau de maîtrise sur un domaine pour les élèves de la classe sélectionnée',
      );
      a(
        'releve_evaluations.colonne.hint.btnValidationAutoNivAcqRefDisciplinaire',
        "Calcul du niveau de maîtrise de l'élément",
      );
      a(
        'releve_evaluations.piedDePage.AppreciationGeneraleClasse',
        'Appréciation générale de la classe #1 pour le service #2',
      );
      a(
        'releve_evaluations.menucontextuel.ModifierPosLSU',
        "Modifier le positionnement de l'élève",
      );
      ...
      a(
        ...
        'Modifier le niveau de maîtrise du domaine',
      );
      ...
      a(
        ...
        'Doit-on tenir compte de la compétence dans les différents calculs automatiques du positionnement ?',
      );
      a(
        'releve_evaluations.fenetrePersonnalisationListe.colonnes.hintDomaines',
        'Domaines du socle pour les bilans de cycle',
      );
      a(
      ...
      a(
        ...
        'Affecter une appréciation aux élèves sélectionnés',
      );
      a(
        'releve_evaluations.parametres.ParOrdreChronologique',
        'Affichage des évaluations par ordre chronologique',
      );
      a(
        'releve_evaluations.parametres.ParOrdreChronologiqueInverse',
        'Affichage des évaluations par ordre chronologique inversé',
      );
      a(
        'releve_evaluations.parametres.AffichageModeCompact',
        'Affichage compact des évaluations',
      );
      a(
        'releve_evaluations.parametres.AffichageModeNormal',
        'Affichage normal des évaluations',
      );
      a(
        'releve_evaluations.parametres.AffichageModeSimpleLigne',
        'Ne pas adapter la hauteur des lignes à la taille des appréciations',
      );
      a(
        'releve_evaluations.parametres.AffichageModeMultiLigne',
        'Adapter la hauteur des lignes à la taille des appréciations',
      );
      a(
      ...
      a(
        ...
        'Positionnement des périodes précédentes',
      );
      a(
        'releve_evaluations.parametres.AvecPosLSUNote',
        "Note saisie par l'enseignant",
      );
      a(
      ...
      a(
        ...
        'Différentes simulations pour le calcul du positionnement',
      );
      a(
        'releve_evaluations.parametres.Evolution.SurTauxReussite',
        'par rapport à son taux de réussite',
      );
      a(
      ...
      a(
        ...
        'par rapport à son niveau de maîtrise',
      );
      a(
        'releve_evaluations.parametres.AvecEvaluationsCoeffNul',
        'Afficher les évaluations de coefficient nul',
      );
      a(
        'releve_evaluations.parametres.AvecRegroupementParDomaine',
        'Regrouper les évaluations par domaine',
      );
      a(
        'releve_evaluations.parametres.AvecEvaluationsHistoriques',
        'Afficher le détail des évaluations des années précédentes',
      );
      a(
      ...
      a(
        ...
        "(*) Sous réserve que l'option soit active dans la maquette du bilan périodique",
      );
      a(
        'releve_evaluations.parametres.SelonOptionCalculNivAcqui',
        "(*) Sous réserve que l'option soit active dans le calcul des niveaux de maîtrise des domaines",
      );
      a(
        'releve_evaluations.calculAutoColonneLSL.titre',
        "Calcul du niveau de maîtrise de l'élément pour les élèves",
      );
      a(
      ...
      a(
        'FicheStage.documentsDeStageSigneManuellement',
        'Documents de stage (signés manuellement)',
      );
      a(
      ...
      a(
        'FicheStage.lEleveOuSonResponsable',
        "l'élève (ou son responsable légal)",
      );
      ...
      a(
        'FicheStage.derogationTravauxInterdits',
        'Déclaration de dérogation aux travaux interdits aux mineurs de plus de 15 ans',
      );
      a(
        'FicheStage.lEntrepriseAttesteDerogationAvecDate',
        "L'entreprise atteste avoir adressé à l'inspecteur du travail le %s la déclaration de dérogation aux travaux interdits aux mineurs prévue à l'article R.4153-41 du code du travail.",
      );
      a(
        'FicheStage.lEntrepriseAttesteDerogationSansDate',
        "L'entreprise atteste avoir adressé à l'inspecteur du travail la déclaration de dérogation aux travaux interdits aux mineurs prévue à l'article R.4153-41 du code du travail.",
      );
      ...
      a(
        'iCal.ChoixDonnees.uniquementMesEvtsAgenda',
        "Uniquement mes événements d'agenda",
      );
      ...
      a(
        ...
        "Voulez-vous remplacer l'appréciation existante par la concaténation des appréciations des référents des stages de l'élève ?",
      );
      ...
      a(
        ...
        'Appréciations de stage des référents',
      );
      a(
      ...
      a(
        'fenetrePJ.filtre.afficherProgression',
      ...
      a(
        'FenetreCorrespondance.TypeCorrespondance',
        'Choix du type de la correspondance',
      );
      ...
      a(
        'punition.hint.Etat',
        'Etat de la punition (réalisée, à réaliser, non réalisée)',
      );
      a(
        'punition.hint.Dossier',
        "Double clic pour publier le dossier lié à la punition dans les dossiers de la vie scolaire sur l'Espace Parents",
      );
      a(
        'punition.hint.Publication',
        "Double clic pour publier la punition dans le carnet de correspondance sur l'Espace Parents",
      );
      ...
      a(
        ...
        "L'élève a déjà une autre punition programmée dans ce créneau horaire.",
      );
      ...
      a(
        ...
        "Diffuser l'information dans l'établissement",
      );
      a(
        'punition.informerEquipePedagogique',
        "Diffuser l'information à l'équipe pédagogique de l'élève, à ses accompagnants et aux CPE",
      );
      a('punition.messageEnvoye', 'Message envoyé');
      a(
        'punition.publierPunition',
        "Publier la punition dans le carnet de correspondance sur l'Espace Parents",
      );
      ...
      a(
        ...
        "Pour pouvoir changer le type de la retenue, vous ne devez avoir qu'une seule programmation !",
      );
      ...
      a(
        ...
        "La punition est publiée dans le carnet de correspondance sur l'Espace Parents depuis le %s",
      );
      a(
        'punition.seraPublieeLe',
        "La punition sera publiée dans le carnet de correspondance sur l'Espace Parents le %s",
      );
      a(
        'punition.nonPubliee',
        "La punition n'est pas publiée dans l'Espace Parents",
      );
      ...
      a(
        ...
        "Vous avez programmé une punition sur un jour non-ouvré.\nConfirmez-vous le '%s' comme date d'exécution de la punition ?",
      );
      a(
        'punition.msgAnnulationReport',
        "Confirmez-vous l'annulation du report de la progammation ?",
      );
      a(
        'punition.suppressionConfirmation',
        'Confirmez-vous la suppression de la punition sélectionnée ?',
      );
      a(
        'punition.suppressionImpossible',
        "Les punitions notifiées par d'autres enseignants ou personnels de vie scolaire ne peuvent être supprimées qu'en mode de connexion administratif ou les auteurs de ces punitions",
      );
      a('punition.surveillances', 'Punitions');
      a('punition.surveillance.toutes', 'Toutes');
      a(
        'punition.surveillance.lesMiennes',
        'Uniquement celles que je surveille',
      );
      a(
        'punition.surveillance.lesNonAttribuees',
        'Uniquement celles sans surveillance',
      );
      ...
      a(
        'BulletinEtReleve.ListeSelectionRegroupement',
      ...
      a(
        'BulletinEtReleve.signalerMoyenneNR',
        'Signaler la moyenne comme non représentative',
      );
      ...
      a(
        'resultatsClasses.options.afficherElevesParNumeroNational',
        'Afficher les élèves par leur Numéro National',
      );
      ...
      a(
        ...
        "Toutes les informations médicales seront automatiquement diffusées au corps médical de l'établissement",
      );
      a(
      ...
      a(
        'infosperso.ouvrirAuxEleves',
        'Autoriser mes élèves à déposer des documents dans mon casier',
      );
      ...
      a(
        ...
        "Ajouter les contenus d'un programme",
      );
      ...
      a(
        ...
        '(*) Éléments déjà affectés à un cours',
      );
      a(
        'progression.SelectionnerDonnees',
        'Sélectionner les éléments à affecter au cours :',
      );
      a('progression.HintDateAffectation', 'Affecté le');
      a(
        'progression.MsgDejaAffectesCDT',
        'Des éléments ont déjà été affectés à ce cours. Confirmez-vous leur remplacement ?',
      );
      a(
        'progression.LeCahierEstVerrouille',
        'Le cahier de textes est verrouillé.',
      );
      ...
      a(
        ...
        'Dossier + Sous-dossier + Titre',
      );
      a(
        'progression.SelectionDeLaProgressionsACopier',
        'Sélectionnez la progression à copier',
      );
      ...
      a(
        ...
        'Visualisation des éléments du dossier sélectionné',
      );
      a(
        'progression.SelectionnezElement',
        'Sélectionnez un élément ou un dossier de la progression',
      );
      ...
      a(
        ...
        "Aucun programme n'est disponible dans ce niveau",
      );
      a('progression.TITREBOITECONF', "Import des contenus d'un programme");
      a('progression.MSGBOITECONF', 'Voulez-vous');
      a(
        'progression.AJOUTERCONTENU',
        'Ajouter les contenus du programme dans votre progression',
      );
      a(
        'progression.REMPLACER',
        "Effacer et remplacer l'intégralité de votre progression par les contenus du programme",
      );
      ...
      a(
        ...
        'Cliquez/glissez les contenus sur un cours de votre emploi du temps pour affecter le cahier de textes',
      );
      a(
        'progression.MsgDejaAffecteAuCours',
        'Le contenu a déjà été affecté au cours sélectionné. Confirmez-vous son remplacement ?',
      );
      a(
        'progression.MsgAffecteAuCours',
        "Confirmez-vous l'affectation du contenu au cours ?",
      );
      a('progression.MsgOptionsTitreElement', 'Composition du titre :');
      a(
        'progression.MsgTAFDejaAffecteAuCours',
        'Le travail à faire a déjà été affecté au cours sélectionné. Confirmez-vous son remplacement ?',
      );
      a(
        'progression.MsgAffecteTAFAuCours',
        "Confirmez-vous l'affectation du travail à faire au cours ?",
      );
      a('progression.TAFPourLe', 'Travail à faire pour le');
      a(
        'progression.ProgressionDeBibliotheque',
        'Consultable dans la bibliothèque des progressions',
      );
      a(
        'progression.ProgressionPartagee',
        'Partagée par plusieurs enseignants',
      );
      ...
      a(
        'CahierDeTexte.TAF_MsgPublicationNouveauTaf',
        "Votre établissement a choisi de désactiver la publication des nouveaux travaux à faire saisis entre %0:s et %1:s.\nLe nouveau travail à faire, que vous êtes en train de créer, ne sera publié qu'à partir de %2:s demain.",
      );
      ...
      a(
        ...
        'sous réserve que ce cahier de textes soit publié',
      );
      ...
      a(
        ...
        'Élèves concernés par le travail à faire',
      );
      a(
        'CahierDeTexte.taf.DureeTAFHint',
        'Durée estimée du travail (affichée sur les Espaces Parents et Élèves)',
      );
      a(
        'CahierDeTexte.taf.NiveauTAFHint',
        'Niveau de difficulté du travail (affiché sur les Espaces Parents et Élèves)',
      );
      a('CahierDeTexte.taf.SelectionNiveauDifficulte', 'Niveaux de difficulté');
      a(
        'CahierDeTexte.taf.SupprimerTAFsSelect',
        'Supprimer les travaux à faire sélectionnés',
      );
      ...
      a(
        ...
        'Activer la mise en forme dans la description',
      );
      a(
      ...
      a(
        ...
        "Audio - A enregistrer sur l'Espace Élèves (3 minutes max)",
      );
      ...
      a(
        ...
        'Choix des éléments travaillés du programme',
      );
      a(
      ...
      a(
        'FicheBrevet.texteExplicatifBrevet',
        "Seules les moyennes périodiques des services de notation complets (c'est-à-dire avec une moyenne ou annotation et une appréciation) sont affichées dans la fiche brevet et prises en compte dans le calcul des moyennes annuelles qui seront exportées vers LSU.",
      );
      a(
      ...
      a(
        'EDT.AppelVerrouFait',
        "L'appel a été fait et la feuille d'appel n'est plus modifiable.",
      );
      ...
      a(
        'Absence.WAI.NavigationVerticalAvecValidation',
      ...
      a(
        'AbsenceVS.AriaListeFeuilleAppel',
        "Liste des élèves de la feuille d'appel",
      );
      ...
      a(
        ...
        'Publié sur les Espaces Parents et Élèves selon la décision du professeur, à partir de %s',
      );
      ...
      a(
        'AbsenceVS.ModifierUnMemoDeLaVieScolaire',
        'Modifier un mémo de la vie scolaire',
      );
      a(
        'AbsenceVS.AjouterUnMemoDeLaVieScolaire',
        'Ajouter un mémo de la vie scolaire',
      );
      ...
      a(
        'ConvocationVS.ConvocationALaVieScolaire',
        'Convocation à la vie scolaire',
      );
      a(
        'ConvocationVS.GererLesConvocations',
        'Gérer les convocations à la vie scolaire',
      );
      ...
      a(
        'ConvocationVS.ConvoquerEleveALaVS',
        "Convoquer l'élève à la vie scolaire",
      );
      ...
      a(
        ...
        "Naviguer vers le relevé de notes de l'élève",
      );
      a(
        'SuiviElevesTutores.Navigation.NaviguerVersBulletinDeNotes',
        "Naviguer vers le bulletin de notes de l'élève",
      );
      ...
      a(
        ...
        'La moyenne est considérée comme non représentative pour le contrôle continu',
      );
      ...
      a(
        'Fenetre_SaisieAgenda.ChoisirLieuEvenement',
        "Sélectionner un lieu d'évènement",
      );
      ...
      a(
        ...
        'Saisir un nouvel encouragement/valorisation',
      );
      a(
        'CarnetCorrespondance.NouveauDefautCarnet',
        'Saisir un nouveau défaut de carnet/carte',
      );
      ...
      a(
        'CarnetCorrespondance.PublieeSurLesEspacesParentsEtELeves',
        'Publiée sur les Espaces Parents et Élèves',
      );
      a(
        'CarnetCorrespondance.PublieeNonSurLesEspacesParentsEtELeves',
        'Non publiée sur les Espaces Parents et Élèves',
      );
      a(
        'CarnetCorrespondance.VisibleSurFeuilleAppelJusquAu',
        "Visible sur la feuille d'appel jusqu'au %s",
      );
      a(
        'CarnetCorrespondance.AucuneEntreeDisponiblePourCetteRubrique',
        'Aucune entrée disponible pour cette rubrique.',
      );
      a(
        'CarnetCorrespondance.AucuneRubriqueDisponible',
      ...
      a(
        ...
        'Commentaire (publié aux parents et aux élèves)',
      );
      ...
      a(
        ...
        'Description sur ce qui est attendu',
      );
      a(
      ...
      a(
        'ExecutionQCM.presentation.rejouer',
        '<p><strong>Rejouer </strong>les mauvaises r&eacute;ponses et les r&eacute;ponses partielles</p>',
      );
      a(
      ...
      a(
        ...
        'Associer le QCM à un cahier de textes',
      );
      a(
        'QCM.PourCDT.SansSelectionCours',
        'Sélectionnez un cours pour pouvoir y associer le QCM',
      );
      a('QCM.PourCDT.CommentCDT', 'Associer le QCM');
      a('QCM.PourCDT.CommentContenu', 'En tant que contenu (Pour réviser)');
      a(
        'QCM.PourCDT.CommentTAF',
        'En tant que travail personnel à effectuer - A rendre le',
      );
      ...
      a(
        'PageCompte.ConfirmerSupprimerAppliMobile',
        'Etes-vous sûr de vouloir retirer cette application de la liste des applications "reconnus"?',
      );
      ...
      a(
        ...
        "Sélectionner des issues d'intervention",
      );
      a(
        'RecapAbs.IssueInterventionInfirmerieSur',
        "Issue(s) d'intervention sur",
      );
      a(
        'RecapAbs.ToutesLesInterventionsIfirmeries',
        "Toutes les issues d'intervention",
      );
      a(
      ...
      a(
        'AbsenceVS.encouragementDepuis',
        '%d encouragement/valorisation depuis le %s',
      );
      a(
        'AbsenceVS.encouragementsDepuis',
        '%d encouragements/valorisations depuis le %s',
      );
      ...
      a(
        'Rencontres.aucuneSession',
        "Aucune session de rencontre parent/professeur n'est définie",
      );
      a(
        'Rencontres.aucuneRencontrePlanifiee',
        "Aucune rencontre n'a encore été planifiée dans cette session",
      );
      a(
        'Rencontres.aucuneRencontre',
        "Aucune rencontre n'est présente dans cette session",
      );
      ...
      a(
        ...
        'Afficher les rencontres non planifiées',
      );
      ...
      a(
        ...
        'Les desiderata de cette session pourront être saisis entre le %s et le %s',
      );
      a(
        'Rencontres.desiderata.saisieJusquA',
        "Les desiderata de cette session pourront être saisis jusqu'au %s",
      );
      a(
        'Rencontres.desiderata.saisieCloturee',
        'La saisie des desiderata de cette session est clôturée',
      );
      a(
        'Rencontres.desiderata.saisieParametrage',
        "Le paramétrage effectué par l'établissement ne vous permet pas de saisir vos desiderata",
      );
      a(
        'Rencontres.desiderata.NonRenseignes',
        'Desiderata non renseigné sur les rencontres prévues : %s',
      );
      ...
      a(
        ...
        'Seuls %s desiderata sont autorisés.',
      );
      a(
        'Rencontres.msgDesactiveResponsable',
        'Si vous souhaitez demander une rencontre avec cet enseignant, vous devez en désactiver une autre.',
      );
      a(
        'Rencontres.msgDesactiveEnseignant',
        'Si vous souhaitez demander une rencontre pour cet élève, vous devez en désactiver une autre.',
      );
      ...
      a(
        ...
        'Personnaliser mes plages de disponibilité',
      );
      ...
      a(
        ...
        'Vous êtes disponible pour les rencontres :',
      );
      ...
      a(
        ...
        'Recherche pour le cours du %s à %s',
      );
      ...
      a(
        ...
        'Des ressources incompatibles entre-elles (%s) ont été supprimées de la recherche.',
      );
      ...
      a(
        'CreneauxLibres.VoirSallesNonReservables',
        'Voir les salles non réservables',
      );
      ...
      a(
        ...
        "Dans un des autres groupes pouvant s'échanger des élèves",
      );
      a(
        'ChoixEleveGAEV.coche.affectesAucunGroupe',
        'Dans aucun des autres groupes pouvant accueillir les mêmes élèves',
      );
      a(
        'ChoixEleveGAEV.coche.uniquementsPresents',
        'Voir uniquement les élèves présents',
      );
      a('ChoixEleveGAEV.LettreAbsenceClasse', 'C');
      a('ChoixEleveGAEV.LettreAbsenceEleve', 'E');
      a(
        'ChoixSemainesEleveGAEV.ReporterElevesGroupe',
        "Reporter les élèves du groupe sur d'autres semaines",
      );
      a(
        'ChoixSemainesEleveGAEV.AffecterElevesGroupeDeCycle',
        'Affecter les élèves du groupe de la',
      );
      a('ChoixSemainesEleveGAEV.EnCours', 'en cours');
      a(
        'ChoixDateEleveGAEV.InfosModificationDansGroupe',
        'Dans tous les cas, toute modification ne sera effective que sur les semaines où les élèves sont présents dans la classe du groupe.',
      );
      a(
        'ChoixDateEleveGAEV.InfosSuppressionDansGroupe',
        'Le retrait des élèves ne sera effectif que sur les semaines où les élèves sont présents dans la classe du groupe.',
      );
      a(
        'ChoixDateEleveGAEV.IndicationNoteEvaluationGroupe',
        "Et uniquement si aucune note ou évaluation n'a été saisie pour un autre groupe.",
      );
      a(
        'ChoixDateEleveGAEV.ConfirmezLesDeuxS',
        'Confirmez-vous la modification des élèves %s ?',
      );
      a(
        'ChoixDateEleveGAEV.SemaineSelectionneeDuAu',
        'pour la semaine sélectionnée (du %s au %s)',
      );
      a(
        'ChoixDateEleveGAEV.SemainesSelectionneesDuAu',
        'pour toutes les semaines affichées (du %s au %s)',
      );
      a('ChoixDateEleveGAEV.JusqueFinSemaine', "jusqu'au");
      a(
        'ChoixDateEleveGAEV.JusqueFinAnnee',
        "jusqu'à la fin de l'année scolaire (du %s au %s)",
      );
      ...
      a(
        ...
        'Partagée avec les enseignants, administratifs et personnels de vie scolaire',
      );
      ...
      a(
        'listeDiffusion.libelleListeFiltre',
      ...
      a(
        ...
        'Nombre des derniers messages conservés lors de la purge des anciens messages',
      );
      a(
      ...
      a(
        ...
        'tous les messages, informations et sondages',
      );
      a(
        'PrefMess.UniquementLesMessagesDesParentsEtEleves',
        'uniquement les messages, informations et sondages des responsables et des élèves',
      );
      ...
      a(
        'PrefMess.definissezPlagesDeco',
        'Définissez les plages de déconnexion durant lesquelles vous ne souhaitez pas recevoir les <strong>messages, informations et sondages</strong>.',
      );
      a(
        'PrefMess.notesEtTafDefiniesParSPR',
        "Concernant les <strong>notes</strong> et le <strong>travail à faire</strong>, ces plages sont définies par le chef d'établissement.",
      );
      ...
      a(
        'PrefMess.desactivationReceptionPendantDeconnexionDe',
        'Pendant mes plages de déconnexion, je désactive la réception des messages, informations et sondages de',
      );
      ...
      a(
        ...
        "Projet d'accompagnement (PAI, PPS, PAP, ...)",
      );
      a(
        'ListeRessources.hintConfigurerPA',
        "Configurer l'affichage des projets d'accompagnements",
      );
      ...
      a(
        'ListeRessources.AccompagnementPersonnalise',
      ...
      a(
        ...
        '%s - Élèves rattachés dans la période sélectionnée',
      );
      a('ListeRessources.ElevesTutores', 'Élèves tutorés');
      a(
        'ListeRessources.HintElevesTutores',
        'Élève dont le professeur est tuteur',
      );
      ...
      a(
        ...
        'Dernière connexion responsable',
      );
      ...
      a(
        'ListeRessources.AfficherDatesValidite',
        'Afficher les dates de validité des projets',
      );
      ...
      a(
        ...
        "Parmi les documents d'une autre classe",
      );
      ...
      a(
        ...
        "Ressources pédagogiques affectées à d'autres classes/groupes",
      );
      a(
        'RessourcePedagogique.DocumentIdentique_Classe_S',
        'Un document de même nom est affecté à la (aux) classe(s) %s, souhaitez-vous :',
      );
      a(
        'RessourcePedagogique.DocumentIdentique_Groupe_S',
        'Un document de même nom est affecté au(x) groupe(s) %1:s, souhaitez-vous :',
      );
      a(
        'RessourcePedagogique.DocumentIdentique_Niveau_S',
        'Un document de même nom est affecté au(x) niveau(x) %2:s, souhaitez-vous :',
      );
      a(
      ...
      a(
        ...
        'Conserver le document existant et affecter ce nouveau document aux destinataires sélectionnés.',
      );
      a('RessourcePedagogique.AutoriserModif', 'Autoriser la modification');
      a(
        'RessourcePedagogique.AucuneMatiereClasse',
        "Les classes sélectionnées n'ont aucune matière en commun.",
      );
      a(
        'RessourcePedagogique.AucuneMatiereGroupe',
        "Les groupes sélectionnés n'ont aucune matière en commun.",
      );
      a(
        'RessourcePedagogique.AucuneMatierePourLaClasse',
        "Aucune matière n'est enseignée dans cette classe (ni cours, ni service de notation)",
      );
      a(
        'RessourcePedagogique.AucuneMatierePourLeGroupe',
        "Aucune matière n'est enseignée dans ce groupe (ni cours, ni service de notation)",
      );
      a(
        'RessourcePedagogique.CeNomExisteDeja',
        'Ce nom est déjà utilisé par un autre document',
      );
      ...
      a(
        ...
        'Le document sélectionné est présent dans des cahiers de textes : sa suppression le rendra inaccessible pour les élèves des classes concernées.',
      );
      ...
      a(
        ...
        'Les moyennes des matières pour %s sont respectivement :',
      );
      a(
        'SuiviPluriannuel.altGraph.annee',
        'Les moyennes des matières pour %s sont :',
      );
      ...
      a(
        'ParcoursPeda.SaisieParcoursPeda',
        "Saisie d'un parcours éducatif : %s",
      );
      a(
        'ParcoursPeda.descriptionObligatoire',
      ...
      a(
        ...
        'Devoir associé au cahier de textes :',
      );
      a(
        'Fenetre_DevoirSurTable.ModifierLEvalAssociee',
        'Évaluation associée au cahier de textes :',
      );
      a(
        'Fenetre_DevoirSurTable.CompetenceItemsManquant',
        'Les items doivent être renseignés.',
      );
      ...
      a(
        ...
        'Saisir une absence sur la journée',
      );
      a(
        'grilleAbsence.HintEnleverAbsenceJournee',
        'Enlever une absence sur la journée',
      );
      a(
        'grilleAbsence.HintSaisieCarnetOublieJournee',
        'Saisir un défaut de carnet/carte',
      );
      a(
        'grilleAbsence.HintEnleverCarnetOublieJournee',
        'Enlever un défaut de carnet/carte',
      );
      ...
      a(
        'grilleAbsence.SelectionnerLeMotifDeLAbsence',
        "Sélectionner le motif de l'absence",
      );
      a(
        'grilleAbsence.HintAfficherListeRecapitulative',
        'Afficher/cacher la liste de recapitulatif annuel',
      );
      ...
      a(
        'grilleAbsence.liste.hint.HeureCours',
        "Nombre d'heures de cours manquées par absence ou durée du retard",
      );
      ...
      a(
        'grilleAbsence.liste.hint.DJBrutes',
        "Nombre de demi-journées d'absence brutes",
      );
      a('grilleAbsence.liste.titre.DJCalc', 'Cal.');
      a(
        'grilleAbsence.liste.hint.DJCalc',
        "Nombre de demi-journées d'absence calculées",
      );
      a('grilleAbsence.liste.titre.DJBulletin', 'Bul.');
      a(
        'grilleAbsence.liste.hint.DJBulletin',
        "Nombre de demi-journées d'absence inscrites sur le bulletin",
      );
      ...
      a(
        ...
        "Nombre d'éléments signifiants",
      );
      a(
        'competencesGrilles.GrilleCompetences.HintNbCompetencesNumeriques',
        'Nombre de compétences numériques (du domaine) où est attendu un positionnement sur une échelle de 1 à 8',
      );
      a(
        'competencesGrilles.GrilleCompetences.HintNbItems',
        'Nombre de compétences attendues en fin de cycle',
      );
      a(
        'competencesGrilles.GrilleCompetences.HintNbItemsCompetencesNumeriques',
        "Nombre d'items évalués dans le domaine",
      );
      a(
        'competencesGrilles.GrilleCompetences.HintLVE',
        'Option à activer pour les référentiels de langues vivantes étrangères, permettant de préciser le niveau de langue (A1, A2, B1,...) de chaque compétence',
      );
      a(
      ...
      a(
        ...
        'Élément signifiant associé dans les bilans',
      );
      ...
      a(
        'competencesGrilles.ListeCompetences.placeHolderNiveaux',
        'Sélectionner les niveaux',
      );
      a(
        'competencesGrilles.ListeCompetences.HintDomainesAssocies',
        'Indique pour quels domaines du socle les évaluations de chaque compétence sont prises en compte lors du calcul des niveaux de maîtrise des bilans de cycle',
      );
      a(
        'competencesGrilles.ListeCompetences.HintLibelleBulletin',
        'Libellé abrégé utilisé dans le bilan périodique',
      );
      a(
        'competencesGrilles.ListeCompetences.HintNiveauLVE',
        'Niveau commun de référence du CECRL',
      );
      a(
      ...
      a(
        ...
        'Copier les items sélectionnés',
      );
      a(
        'competencesGrilles.ListeCompetences.CollerElementCompetence',
        'Coller les items dans les compétences sélectionnées',
      );
      ...
      a(
        ...
        'Peut être utilisé dans les évaluations',
      );
      a(
        'competencesGrilles.ListeCompetences.CompetenceNonEvaluable',
        'Ne peut pas être utilisé dans les évaluations',
      );
      a(
        'competencesGrilles.ListeCompetences.InfoUtiliteNiveauCompNumeriques',
        'Cette compétence numérique ne sera pas prise en compte dans la validation du référentiel.',
      );
      a(
        'competencesGrilles.GrilleCompetences.AjoutMetamatiere.Titre',
        '%s - Ajouter un référentiel',
      );
      a(
      ...
      a(
        ...
        'Afficher uniquement les matières affectées à des services',
      );
      a(
        'competencesGrilles.GrilleCompetences.AjoutDomaine.Titre',
        'Edition des domaines',
      );
      ...
      a(
        'competencesGrilles.ListeCompetences.FenetreChoixNiveaux.TousLesNiveaux',
        'Tous les niveaux',
      );
      a(
        'competencesGrilles.ListeCompetences.FenetreChoixNiveaux.UniquementLesNiveaux',
        'Uniquement les niveaux',
      );
      a(
      ...
      a(
        ...
        "Afficher le nombre d'évaluations par compétence",
      );
      a(
        'competencesGrilles.FenetreParametrage.GererSousItems',
        'Gérer les sous-items',
      );
      a(
      ...
      a(
        ...
        'Masquer les éléments officiels',
      );
      a(
        'competencesGrilles.Parametrage.AfficherSeulementEvaluables',
        'Afficher uniquement les évaluables',
      );
      ...
      a(
        ...
        'Afficher les devoirs / évaluations de coefficient 0',
      );
      a(
      ...
      a(
        ...
        'Afficher les périodes verticalement',
      );
      a(
        'AppreciationsBulletinEleve.FenetreParametrageAffichage.AfficherDevoirsEvals',
        'Afficher le nombre de devoirs / évaluations',
      );
      a(
      ...
      a(
        ...
        'Compacter / Elargir les colonnes',
      );
      a(
        'AppreciationsBulletinEleve.BoutonBandeau.OrdreChrono',
        "Inverser l'ordre chronologique des devoirs et évaluations",
      );
      a(
        'AppreciationsBulletinEleve.HintMoyenne',
        'Moyenne du bulletin calculée en prenant en compte tous les devoirs de la période',
      );
      a(
      ...
      a(
        ...
        'Vous allez remplacer des éléments de programme déjà saisis. Voulez-vous continuer ?',
      );
      a(
        'InterfaceCDTPlanning.ConfirmerRemplacerContenuExistant',
        'Vous allez remplacer du contenu déjà saisi. Voulez-vous continuer ?',
      );
      a(
        'InterfaceCDTPlanning.ConfirmerRemplacerAFaireExistant',
        'Vous allez remplacer du travail à faire déjà saisi. Voulez-vous continuer ?',
      );
      a(
        'InterfaceCDTPlanning.ConfirmerSuppressionEltPgm',
        'Voulez-vous retirer les éléments de programme de ce cahier de textes ?',
      );
      a(
        'InterfaceCDTPlanning.UniquementTitre',
        'Afficher uniquement le titre des contenus',
      );
      a(
        'InterfaceCDTPlanning.IntegraliteContenus',
        "Afficher l'intégralité des contenus",
      );
      ...
      a(
        ...
        "J'associe mon compte Cloud PRONOTE à cet établissement",
      );
      ...
      a(
        ...
        'Nombre de travaux faits ou rendus pour la classe ou le groupe',
      );
      ...
      a(
        ...
        "Télecharger la copie de l'élève",
      );
      a(
        'RecapDevoirRendu.hintCopie.consulterQCM',
        "Consulter le QCM de l'élève",
      );
      ...
      a(
        ...
        'Cochez les types de travail à faire à prendre en compte',
      );
      a(
        'RecapDevoirRendu.fenetreOptions.avecQCM',
        'QCM donné comme travail à faire',
      );
      a(
        'RecapDevoirRendu.fenetreOptions.avecDepot',
        "Travail à déposer sur l'Espace Élève",
      );
      a(
        'RecapDevoirRendu.fenetreOptions.avecRendu',
        'Travail à rendre au professeur',
      );
      a(
        'RecapDevoirRendu.fenetreOptions.avecSansRendu',
        'Travail à faire sans rendu',
      );
      ...
      a(
        ...
        'Des matières de la ressource pédagogique',
      );
      ...
      a(
        'RDV.ajouterEnPlusDansAgendaDe',
        "Afficher également le rendez-vous (participant, objet et lieu) dans l'agenda de",
      );
      a(
        'RDV.RDVSeraAfficheAgendaParticipants',
        "Le rendez-vous est automatiquement affiché dans l'agenda des participants",
      );
      ...
      a(
        ...
        "L'appel a déjà été effectué, confirmez-vous la modification de la feuille d'appel ?",
      );
      a(
        'AppelInternat.messConfirmezSaisieAbsenceInternatSurStage',
        "Cet élève n'est pas prévu à l'internat pendant la durée de son stage (Stages > Fiche de stage > Hébergement).\nSouhaitez-vous tout de même le signaler absent de l'internat ?",
      );
      a(
      ...
      a('$AppliMobile', (b) => {
        ...
        a(
          `${b}.ModeOpQrCode`,
          "Pour générer le QR code, permettant l'ajout de votre compte sur l'application mobile PRONOTE, vous devez définir un code de vérification",
        );
        ...
        a(
          `${b}.MethodeConfig`,
          "Depuis un téléphone, installez l'application PRONOTE (disponible sur tous les stores).",
        );
        a(
      ...
      a('$ChoixDestinatairesParCriteres', (b) => {
        ...
        a(`${b}.MatierePref`, 'Matière préférentiel');
      ...
      a('$CookieAnnonce', (b) => {
        a(
          `${b}.CookieInfo_Message_1`,
          'Seuls des cookies (ou informations stockées en local) de fonctionnement sont utilisés.',
        );
        a(
          `${b}.CookieInfo_Message_2_S`,
          "Pour plus d'informations, voir notre %s.",
        );
      ...
      a('$DoubleAuth', (b) => {
        ...
        a(
          `${b}.EnSavoirPlusTitle`,
          'En savoir plus sur la sécurisation du compte',
        );
        a(
          `${b}.LegendeStrategie`,
      ...
      a('$GlossaireAbsences', (b) => {
        a(
          `${b}.enAttenteDeTraitement`,
          'En attente de traitement par la vie scolaire',
        );
        a(`${b}.enAttenteDeComplement`, "Complément d'information attendu");
        a(`${b}.widget`, (b) => {
          a(`${b}.enAttenteDeTraitement`, '%s : en attente de traitement');
          a(
            `${b}.enAttenteDeComplement`,
            "%s : complément d'information attendu",
          );
        });
        ...
        a(
          `${b}.infoAcceptJustificationNonRecevable`,
          'Justification prise en compte mais considérée comme non recevable par la vie scolaire',
        );
        a(
          `${b}.infoRefusJustification`,
          'Justification prise en compte, le motif a été modifié par la vie scolaire',
        );
        a(
          `${b}.infoRefusJustificationNonRecevable`,
          'Justification prise en compte mais considérée comme non recevable, le motif a été modifié par la vie scolaire',
        );
      });
      ...
      a('$GlossaireCasier', (b) => {
        ...
        a(
          `${b}.titreFenetreDestCasier`,
          'Choix des %s destinataires concernés par la diffusion',
        );
        a(
          `${b}.choixCritereDisponibilite`,
        ...
        a(
          `${b}.intervenantDiffusion`,
          'Diffuser aux professeurs / personnels / maîtres de stage',
        );
        a(`${b}.horsContexte`, (b) => {
          a(
            `${b}.intervenantDiffusion`,
            'Diffuser un document aux professeurs / personnels / maitre de stage',
          );
          a(
            `${b}.responsablesDiffusion`,
        ...
        a(
          `${b}.tousLesIndivdusConcernes`,
          'Afficher tous les individus concernés',
        );
        a(
          `${b}.uniqAvecDepot`,
          'Afficher uniquement les individus ayant un document',
        );
        a(
          `${b}.uniqSansDepot`,
          'Afficher uniquement les individus sans document',
        );
        a(`${b}.telechargerLeDocument`, 'Télécharger le document');
        a(`${b}.diffuserUneInfo`, 'Diffuser une information');
        a(`${b}.neeLe`, 'Né(e) le : %s');
        a(
          `${b}.aucunDocumentACellecter`,
        ...
        a(
          `${b}.afficherCollecteNonPublie`,
          'Afficher les collectes non publiées',
        );
        a(
          `${b}.nouvelleCollecteEleve`,
          'Collecter un document auprès des élèves',
        );
        a(
          `${b}.nouvelleCollecteRespEleve`,
          "Collecter un document auprès des responsable, au titre de l'élève",
        );
        a(
          `${b}.nouvelleCollecteResp`,
          'Collecter un document auprès des responsables',
        );
        a(
          `${b}.infosElevesCollecte`,
          '%d élèves sont concernés par la collecte',
        );
        a(`${b}.infosEleveCollecte`, '%d élève est concerné par la collecte');
        a(
          `${b}.infosResponsablesElevesCollecte`,
          '%d responsables sont invités à déposer les documents des %d élèves',
        );
        a(
          `${b}.infosResponsableElevesCollecte`,
          '%d responsable est invité à déposer les documents des %d élèves',
        );
        a(
          `${b}.infosResponsableEleveCollecte`,
          '%d responsable est invité à déposer les documents de %d élève',
        );
        a(
          `${b}.infosResponsablesCollecte`,
          '%d responsables sont concernés par la collecte',
        );
        a(
          `${b}.infosResponsableCollecte`,
          '%d responsable est concernés par la collecte',
        );
        a(`${b}.notificationActivee`, 'Notification activée');
        a(`${b}.definirModalites`, 'Définir les modalités');
        a(
          `${b}.envoiDirectNotif`,
          "La notification va être envoyée sur l'espace %s, confirmez-vous la date de notification ?",
        );
        ...
        a(`${b}.ajouterUnDocument`, 'Ajouter un document');
        ...
        a(
          `${b}.supprLesDocumentsConsultes`,
          'Supprimer les documents consultés',
        );
        a(`${b}.dansLeCasierDe`, 'Dans le casier de');
        a(
          `${b}.commentairePourDestinataire`,
          'Commentaire à destination du destinataire',
        );
        a(`${b}.raisonDuDepotParExemple`, 'Raison du dépôt par exemple');
        a(`${b}.champsDestinataireRequis`, 'Veuillez choisir un destinataire');
        a(
          `${b}.nouveauDepotDansLeCasierDunProfOuPers`,
          "Nouveau dépôt dans le casier d'un professeur ou personnel",
        );
        a(`${b}.casierDeX`, 'Casier de %s');
        a(
          `${b}.titreFenetreSelectionCollecte`,
          'Choix des individus concernés par cette collecte',
        );
        a(
          `${b}.btnTotalFenetreSelectionCollecte`,
          "Nombre d'individus concernés",
        );
        a(
          `${b}.texteExplicatifEleve`,
          'Elèves qui devront déposer le document sur leur Espace',
        );
        a(
          `${b}.texteExplicatifRespEleve`,
          'Choix des élèves pour lesquels leur(s) responsable(s) devront déposer le document sur leur Espace Parents',
        );
        a(
          `${b}.texteExplicatifResp`,
          'Responsables qui devront déposer le document sur leur Espace',
        );
        ...
        a(
          `${b}.deposeParProfPers`,
          'déposé par les professeurs et les personnels',
        );
        a(
          `${b}.deposeParProfPersMdS`,
          'déposé par les professeurs, les personnels et les maîtres de stages',
        );
        ...
        a(
          `${b}.auxProsPersMdS`,
          'Aux professeurs, personnels et maîtres de stages',
        );
        ...
        a(
          `${b}.labelListeIndivCollecteDocument`,
          'Destinataires de la collecte',
        );
        a(`${b}.labelListeDocumentIndiv`, 'Liste des collectes');
        a(
          `${b}.uneFoisLesDocsModifImpossible`,
          "Une fois le document consulté, l'élève ne pourra plus le modifier",
        );
        a(
          `${b}.docDeposePlusModifiableApresConsult`,
          'Les documents déposés ne sont plus modifiables une fois consultés/supprimés par le destinataire',
        );
        a(
          `${b}.pensezASupprimer`,
          'Pensez à supprimer régulièrement les documents',
        );
      });
      ...
      a('$GlossaireDocumentsAtelechargerPN', (b) => {
        ...
        a(`${b}.supprimerDuCasier`, 'Supprimer de mon casier');
        a(
          `${b}.messageSuppression`,
          'Confirmez-vous la suppression du document ?',
        );
        a(
          `${b}.ConfirmSupprDocCasier`,
          'Confirmez-vous la suppression du document %s de votre casier ?',
        );
        ...
        a(
          `${b}.placeholderProfPers`,
          "Sélectionnez le professeur ou un personnel de l'équipe",
        );
        a(
          `${b}.messageAucunFenetreSelection`,
          "Aucun Professeur et Personnel n'accepte de recevoir des documents",
        );
      });
      a('$GlossaireDossierVieScolaire', (b) => {
        a(
          `${b}.TitreFenetreCreationDossier`,
        ...
        a(
          `${b}.XPersonnesOntAccesDossier`,
          '%d personnes ont accès au dossier',
        );
        a(
          `${b}.MsgMotifDossierObligatoire`,
        ...
        a(
          `${b}.DiscussionAvecEquipePeda`,
          "Discussion avec l'équipe pédagogique et les CPE",
        );
      });
      a('$GlossaireEDT', (b) => {
        a(`${b}.Ferie`, 'Férié');
        ...
        a(
          `${b}.MesureResponsabilisation_SS`,
          'Mesure de responsabilisation de %s à %s',
        );
      });
      a('$GlossaireIncident', (b) => {
        ...
        a(
          `${b}.uniquementMesIncidents`,
          "Uniquement les incidents que j'ai signalés",
        );
        ...
        a(
          `${b}.msgSuppressionVerrouille`,
          'Vous ne pouvez pas supprimer un incident verrouillé. Vous devez préalablement le déverrouiller',
        );
        a(`${b}.protagonistes`, (b) => {
          a(`${b}.titre`, 'Personnes impliquées');
          a(
            `${b}.existent`,
            'Le(s) protagoniste(s) suivants existe(nt) dèjà :',
          );
          ...
          a(
            `${b}.auteurEtMesure`,
            "Auteur de l'incident et mesure disciplinaire",
          );
          a(`${b}.prevoirMesure`, 'Prévoir une mesure');
          a(
            `${b}.prevoirMesurePour`,
            'Prévoir une mesure disciplinaire pour %s',
          );
        ...
        a(`${b}.commentaire`, 'Commentaire');
        a(
          `${b}.diffuserEquipesPedagogiques`,
          'Informer les équipes pédagogiques et les CPE',
        );
        ...
        a(`${b}.reglerAdministrativement`, 'Régler administrativement');
        a(`${b}.viseParAdministration`, "Visé par l'administration");
        a(
          `${b}.selectMesuresDisciplinaire`,
          'Sélectionner une mesure disciplinaire',
        );
      ...
      a('$GlossaireListe', (b) => {
        ...
        a(`${b}.wai`, (b) => {
          ...
          a(
            `${b}.NouvelElement`,
            'Pour ajouter un nouvel élément, utilisez les touches entrée ou majuscule + entrée.',
          );
          a(`${b}.MsgRechercheNonTrouve`, 'Aucune ligne trouvée');
          a(
            `${b}.MsgRechercheNonTrouvePour_S`,
            'Aucune ligne trouvée pour "%s"',
          );
          a(
            `${b}.MsgRechercheXTrouveesPour_DDS`,
            '%d sur %d lignes trouvées pour "%s"',
          );
          a(
            `${b}.MsgRechercheXTrouveePour_DDS`,
          ...
          a(
            `${b}.toolbar`,
            "Barre d'outils, Utilisez les flèches gauche et droite pour naviguer.",
          );
        });
      });
      ...
      a('$GlossaireWAI', (b) => {
        ...
        a(
          `${b}.ContenusExcluRGAA`,
          "Des éléments de la page sont fournis par des utilisateurs et peuvent ne pas respecter les normes d'accessibilité RGAA.",
        );
      ...
      a('$InterfaceRecapitulatifExportLSU', (b) => {
        a(
          `${b}.Afficher_uniquement_eleves_non_exportables`,
          'Afficher uniquement les élèves non exportables',
        );
        ...
        a(
          `${b}.DescriptifExportLSU`,
          "Cet export génère le fichier pour l'application LSU (Livret Scolaire Unique).",
        );
        a(
          `${b}.InclureBilanFinDeCycle`,
          'Inclure les bilans de fin de cycle pour %s',
        );
        a(`${b}.ClassesFinDeCycleSecondaire`, 'les 3ème et les 6ème');
        a(`${b}.ClassesFinDeCyclePrimaire`, 'les CE2');
        a(
          `${b}.ExportDonneesDeLaPeriode`,
          "Vous avez choisi d'exporter les données de la période %s.",
        );
        a(
          `${b}.PeriodeDefinieDuAu`,
          'Dans PRONOTE, cette période est définie du %s au %s.',
        );
        a(
          `${b}.VerificationDatesSurONDE`,
          'Vérifier bien que les dates saisies dans LSU pour cette période sont identiques.',
        );
      });
      a('$InterfaceRechercheDeStage', (b) => {
        a(
          `${b}.aucuneSession`,
          "Aucune session de recherche de stage n'a été trouvée.",
        );
        a(
          `${b}.labelComboClasseGroupe`,
          'Sélectionnez une classe ou un groupe',
        );
        ...
        a(
          `${b}.aucunEleveSession`,
          "Vous n'êtes référent d'aucun élève dans cette session",
        );
        ...
        a(
          `${b}.titleSiret`,
          "Le numéro de SIRET d'une entreprise doit être composé de 14 chiffres",
        );
        a(
          `${b}.confirmationSuppressionDemarche`,
          'Voulez-vous supprimer la démarche sélectionnée ?',
        );
        a(
          `${b}.confirmationSuppressionEtape`,
          "Voulez-vous supprimer l'étape selectionnée ?",
        );
        ...
        a(
          `${b}.selectionnezEntrepriseVoulue`,
          'Il y a plusieurs entreprises avec ce n° SIRET, veuillez sélectionner celle qui correspond',
        );
        a(
          `${b}.saisieInfomationsEntreprise`,
          'Saisie des informations entreprise',
        );
        a(`${b}.champsObligatoires`, 'Champs obligatoires');
        a(`${b}.obligatoire`, 'Obligatoire');
        a(
          `${b}.erreurChampsObligatoiresNonSaisis`,
          "Certains champs obligatoires n'ont pas été saisis",
        );
        a(
          `${b}.erreurChampObligatoireNonSaisi`,
          "Un champ obligatoire n'a pas été saisi",
        );
        ...
        a(
          `${b}.tooltipSiret`,
          "Vous pouvez trouver le n° SIRET de toutes les entreprises françaises sur le site d'infogreffe",
        );
        a(`${b}.connaisSiret`, 'Je connais le n° SIRET');
        a(`${b}.neConnaisPasSiret`, 'Je ne connais pas le n° SIRET');
        a(
          `${b}.preremplirGraceSiret`,
          'Rechercher et préremplir les champs grâce au n° SIRET',
        );
        a(`${b}.objetDiscussion`, 'Suivi de recherche de stage');
        a(`${b}.totalTitre`, "États d'avancement de recherche des élèves");
        a(
          `${b}.totalRechercheNonDebutee`,
          'Recherche non débutée : %0:d / %1:d  élèves',
        );
        a(
          `${b}.totalRechercheEnCours`,
          'Recherche en cours : %0:d / %1:d  élèves',
        );
        a(
          `${b}.totalStageTrouve`,
          'Stage trouvé ou existant : %0:d / %1:d  élèves',
        );
        a(
          `${b}.cocheDeclarerleStageTrouve`,
          'Déclarer le stage trouvé dans cette entreprise',
        );
        a(
          `${b}.existeDejaUnStageTrouve`,
          "Il existe déjà une démarche indiquant qu'un stage a été trouvé. Supprimer la si vous voulez en créer une autre",
        );
        a(`${b}.stageExistant`, 'Stage existant');
        a(`${b}.stageCree`, 'Stage créé (issu de la recherche)');
        a(
          `${b}.infoQueDiscussion`,
          'Votre recherche de stage semble déjà aboutie, vous pouvez échanger avec %s',
        );
        a(
          `${b}.entrepriseSaisieFicheDeStage`,
          'Entreprise saisie dans la fiche de stage',
        );
        a(
          `${b}.multiStagesExistant`,
          '%d stages ont été saisis pour cet élève dans la session.',
        );
        a(
          `${b}.multiStagesExistantPourEleve`,
          '%d stages existent pour cette session',
        );
      });
      ...
      a('$MessageMoyenneNR', (b) => {
        a(`${b}.hint`, (b) => {
          a(`${b}.titre`, (b) => {
            ...
            a(
              `${b}.brevet`,
              'Signalez par un double clic les moyennes non représentatives pour le contrôle continu du brevet.',
            );
            a(
              `${b}.autre`,
              'Signalez par un double clic les moyennes non représentatives.',
            );
            a(
              `${b}.bacOuBrevet`,
              'Signalez par un double clic les moyennes non représentatives pour le contrôle continu du baccalauréat ou du brevet.',
            );
          });
          a(`${b}.eleve`, (b) => {
            a(
            ...
            a(
              `${b}.brevet`,
              'La moyenne est considérée comme non représentative pour le contrôle continu du brevet.\nElle sera remplacée par la valeur "En attente" dans l\'export vers LSU.',
            );
      ...
      a('$ObjetCalendrier', (b) => {
        ...
        a(`${b}.WAI`, (b) => {
          ...
          a(
            `${b}.Navigation`,
            'Utilisez les flèches gauche et droite pour sélectionner la semaine précédente ou suivante.',
          );
        });
      });
      ...
      a('$ObjetFenetre_EnvoiEMail', (b) => {
        ...
        a(
          `${b}.messageErreurDestinataires`,
          'Veuillez sélectionner des destinataires',
        );
      ...
      a('$ObjetFenetreHarcelement', (b) => {
        ...
        a(
          `${b}.ReferentsContreHarcelement`,
          'Référent(s) contre le harcèlement',
        );
        a(`${b}.ContacterReferent`, 'Contacter');
        a(`${b}.ContacterX`, 'Contacter %s');
        a(
          `${b}.ElevesAmbassadeurs`,
          'Élève(s) ambassadeur(s) Stop harcèlement',
        );
      });
      ...
      a('$TypeModeAssociationDevoirEvaluation', (b) => {
        ...
        a(
          `${b}.SupprimerLeLienDevoirEvaluation`,
          "Supprimer le lien entre l'évaluation et le devoir",
        );
      });
      ...
      a('$UtilitaireDroitALaDeconnexion', (b) => {
        a(
          `${b}.explicationPourEleve`,
          "Le <strong>droit à la déconnexion</strong> permet de limiter l'affichage de certaines informations en dehors des jours et horaires définis par le chef d'établissement.",
        );
        ...
        a(
          `${b}.leJourDeLeurPubliAuxEleves`,
          'le jour de leur publication aux élèves',
        );
        a(
          `${b}.xJoursApresPubliAuxEleves`,
          '%s jours après leur publication aux élèves',
        );
        a(
          `${b}.unSemaineApresPublicAuxEleves`,
          'une semaine après leur publication aux élèves',
        );
        a(`${b}.modifierLesPreferences`, 'Modifier les préférences');
        a(
          `${b}.messagerieDesactiver`,
          'Vous avez désactivé la réception des messages entre <strong>%s</strong> et <strong>%s (droit à la déconnexion)</strong>',
        );
        a(
          `${b}.infoSondDesactiver`,
          'Vous avez désactivé la réception des informations et sondages entre <strong>%s</strong> et <strong>%s (droit à la déconnexion)</strong>',
        );
        a(
          `${b}.vousEtesEnPeriodeDeconnexion`,
          'Vous êtes actuellement dans une plage horaire où <strong>certaines informations sont masquées</strong> afin de respecter le <strong>droit à la déconnexion</strong>',
        );
        a(
          `${b}.selonVosPreferencesDansMonCompte`,
          'selon vos préférences définies dans "Mon compte"',
        );
        a(
          `${b}.infosMessagesNonPublie`,
          'Les <strong>nouveaux messages, informations et sondages</strong> ne seront pas publiés',
        );
        a(
          `${b}.infosMessagesNonPublieJoursOuvres`,
          'entre %s et %s les %s et %s',
        );
        ...
        a(
          `${b}.infosMessagesNonPublieJoursFeries`,
          'les <strong>jours fériés</strong>',
        );
        a(
          `${b}.infosMessagesNonPublieVacances`,
          'pendant les <strong>vacances scolaires</strong>',
        );
        a(
          `${b}.infosTAF`,
          '<strong>Aucun nouveau travail à faire</strong> ne sera publié de %s à %s',
        );
        a(
          `${b}.infosNotes`,
          'Les <strong>nouvelles notes</strong> seront visibles à partir de <strong>%s</strong>, %s',
        );
      });
      ...
      a('$WidgetInfosParcoursupLSL', (b) => {
        ...
        a(
          `${b}.HintAppreciationsAnnuelles`,
          "Nombre d'appréciations non saisies",
        );
        a(`${b}.HintCompetences`, 'Nombre de compétences non saisies');
        a(`${b}.HintAutres`, 'Autres');
        a(`${b}.LienVoirFicheAvenir`, 'Voir la fiche avenir');
        a(
          `${b}.LienVoirApprAnnuelles`,
          'Voir les appréciations du livret scolaire',
        );
        a(
          `${b}.LienVoirCompetences`,
          'Voir les compétences du livret scolaire',
        );
      });
    };
  },
