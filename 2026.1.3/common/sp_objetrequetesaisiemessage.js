IE.fModule({
  f: function (exports, require, module, global) {
    ...
    const TypeChaineHtml_1 = require('@cp/Produit/Script/Type/TypeChaineHtml');
        ...
        switch (aParam.commande) {
          ...
          case 'purger':
            this.JSON.listeMessagesPurge =
              (_a = aParam.listeMessagesPurge) === null || _a === void 0
                ? void 0
          ...
          case 'pourOuvrirFermer':
            ...
            if (
              (_b = lParam.message) === null || _b === void 0
                ? void 0
                : _b.listePossessionsMessages
            ) {
    ...
    ObjetRequeteSaisieMessage.inscrire('SaisieMessage');
  },
