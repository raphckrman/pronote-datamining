IE.fModule({
  f: function (exports, require, module, global) {
    ...
    (function (TypeGenreEvenementAgenda) {
      ...
      TypeGenreEvenementAgenda[
        (TypeGenreEvenementAgenda['tgea_MesRendezVous'] = 13)
      ] = 'tgea_MesRendezVous';
      TypeGenreEvenementAgenda[
        (TypeGenreEvenementAgenda['tgea_RendezVousPartages'] = 14)
      ] = 'tgea_RendezVousPartages';
      TypeGenreEvenementAgenda[
        (TypeGenreEvenementAgenda['tgea_Election'] = 15)
      ] = 'tgea_Election';
      TypeGenreEvenementAgenda[
        (TypeGenreEvenementAgenda['tgea_ConseilsDiscipline'] = 16)
      ] = 'tgea_ConseilsDiscipline';
      TypeGenreEvenementAgenda[
        (TypeGenreEvenementAgenda['tgea_JourFerie'] = 17)
      ] = 'tgea_JourFerie';
    })(
      TypeGenreEvenementAgenda ||
