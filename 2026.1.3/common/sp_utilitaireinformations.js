IE.fModule({
  f: function (exports, require, module, global) {
    ...
    const UtilitaireListePeriodes_1 = require('@scolys/espace/script/utilitaire/UtilitaireListePeriodes');
    ...
    TUtilitaireInformations.creerActualiteDiffusionDesResultatsSondage =
      function (aSondage, aListeNatures, aListePiecesJointesResultats) {
    ...
    TUtilitaireInformations.appliquerModeleSurExistant = function (aParam) {
      ...
      lInfoSond.nature = lModele.nature;
      ...
      if (lModele.listeQuestions) {
        ...
        lInfoSond.listeQuestions.setTri([ObjetTri_1.ObjetTri.init('rang')]);
      }
      ...
      lInformation.nature = !aParam.nature
        ? !aParam.actualite
          ? (0, AccessApp_1.getApp)()
              .getEtatUtilisateur()
              .listeCategories.get(aParam.indiceNatureParDefaut)
          : aParam.actualite.nature
        : aParam.nature;
    ...
    TUtilitaireInformations.initListePeriodes = function () {
      return UtilitaireListePeriodes_1.UtilitaireListePeriodes.construireListePeriodes(
        [
          UtilitaireListePeriodes_1.UtilitaireListePeriodes.choix.aujourdhui,
          UtilitaireListePeriodes_1.UtilitaireListePeriodes.choix
            .semaineCourante,
          UtilitaireListePeriodes_1.UtilitaireListePeriodes.choix.moisCourant,
          UtilitaireListePeriodes_1.UtilitaireListePeriodes.choix.annee,
          UtilitaireListePeriodes_1.UtilitaireListePeriodes.choix.periodes,
          UtilitaireListePeriodes_1.UtilitaireListePeriodes.choix.mois,
        ],
      );
    };
