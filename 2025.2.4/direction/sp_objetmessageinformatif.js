    ...
    class ObjetMessageInformatif {
      ...
      _afficherContenu(aMessage, aDuree, aDetailMessageInformatif, aParams) {
              ...
              ? IE.jsx.str('div', {
                  class:
                    ObjetMessageInformatif_module_css_1
                      .StylesObjetMessageInformatif.overlay,
                })
              : '',
            IE.jsx.str(
              'div',
              {
                class:
                  ObjetMessageInformatif_module_css_1
                    .StylesObjetMessageInformatif.content,
              },
              IE.jsx.str(
                IE.jsx.fragment,
                null,
                ...
                IE.jsx.str(
                  'div',
                  {
                    class:
                      ObjetMessageInformatif_module_css_1
                        .StylesObjetMessageInformatif.detailMessage,
                ...
                this.AvecBarreDeProgression
                  ? IE.jsx.str(
                      'div',
                      {
                        ...
                        class:
                          ObjetMessageInformatif_module_css_1
                            .StylesObjetMessageInformatif.progress,
                        'aria-hidden': 'true',
                      },
                  ...
                  : '',
                lParams.htmlPied
                  ? IE.jsx.str('div', null, lParams.htmlPied)
                  : '',
              ),
            ),
          ),
        ...
        try {
          ...
          $(
            `#${this.Nom.escapeJQ()} .${ObjetMessageInformatif_module_css_1.StylesObjetMessageInformatif.content}`,
          )
            .finish()
            .css('opacity', 0)
