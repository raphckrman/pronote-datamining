  ...
  f: function (exports, require, module, global) {
    ...
    function inlineWorker() {
      function fetchAndInstantiate(url, imports) {
        ...
        return WebAssembly.instantiateStreaming(req, imports).catch(
          function (err) {
            if (
              err.message &&
              err.message.indexOf(
      ...
      function testSafariWebAssemblyBug() {
        var bin = new Uint8Array([
          ...
          5, 3, 1, 0, 1, 7, 8, 1, 4, 116, 101, 115, 116, 0, 0, 10, 16, 1, 14, 0,
          32, 0, 65, 1, 54, 2, 0, 32, 0, 40, 2, 0, 11,
        ]);
      ...
      _createClass(Recorder, [
        ...
        },
        {
          ...
          value: function initAudio() {
            ...
            return getUserMedia({ audio: true }).then(function (stream) {
              _this.stream = stream;
              var audioCtx = (_this.audioCtx = new (window.AudioContext ||
                window.webkitAudioContext)());
              var sourceNode = audioCtx.createMediaStreamSource(stream);
              var gainNode = (_this.gainNode = (
        ...
        },
        {
          ...
          value: function initWorker() {
            ...
            worker.postMessage({
              type: 'init',
              data: { wasmURL: wasmURL, shimURL: shimURL },
            });
            return new Promise(function (resolve, reject) {
      ...
      _createClass(Form, [
        ...
        },
        {
          ...
          value: function drawAll() {
            ...
            gainWrapper.className =
              'vmsg-slider-wrapper vmsg-gain-slider-wrapper';
            ...
            pitchWrapper.className =
              'vmsg-slider-wrapper vmsg-pitch-slider-wrapper';
            ...
            pitchSlider.onchange = function () {
              ...
              _this7.recorder.gainNode.connect(
                pitch === 0
                  ? _this7.recorder.encNode
                  : _this7.recorder.pitchFX.input,
              );
            };
    ...
    var _default = { Recorder: Recorder, Form: Form, record: record };
    ...
    function Jungle(context) {
      ...
      mod3.loop = true;
      mod4.loop = true;
      var mod1Gain = (context.createGain || context.createGainNode).call(
        context,
      );
      var mod2Gain = (context.createGain || context.createGainNode).call(
        context,
      );
      var mod3Gain = (context.createGain || context.createGainNode).call(
        context,
      );
      mod3Gain.gain.value = 0;
      var mod4Gain = (context.createGain || context.createGainNode).call(
        context,
      );
      ...
      var modGain1 = (context.createGain || context.createGainNode).call(
        context,
      );
      var modGain2 = (context.createGain || context.createGainNode).call(
        context,
      );
      var delay1 = (context.createDelay || context.createDelayNode).call(
        context,
      );
      var delay2 = (context.createDelay || context.createDelayNode).call(
        context,
      );
