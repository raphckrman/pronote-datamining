        ...
        switch (aArticle.getGenre()) {
          case Enumere_Ressource_1.EGenreRessource.Enseignant:
            if (aArticle.estPrincipal) {
              H.push(
                `<p><i class="icon_star m-right-s"></i>${'Professeur principal'}</p>`,
              );
            }
            if (aArticle.estTuteur) {
              H.push(
                `<p><i class="icon_star m-right-s"></i>${'Tuteur'}</p>`,
              );
            }
          ...
          case Enumere_Ressource_1.EGenreRessource.Personnel:
            if (aArticle.estMonCpe) {
              H.push(
                `<p><i class="icon_star m-right-s"></i>${'CPE de mon enfant'}</p>`,
              );
            }
    ...
    UtilitaireMessagerie.getLibelleSuppListePublicsGenreCumulFonction = (
      ...
      if (aArticle) {
        switch (aArticle.getGenre()) {
          case Enumere_Ressource_1.EGenreRessource.Personnel:
            if (aArticle.estMonCpe) {
              return `<p class="m-bottom"><i class="icon_star m-right-s"></i>${'CPE de mon enfant'}</p>`;
            }
            break;
        }
        return '';
