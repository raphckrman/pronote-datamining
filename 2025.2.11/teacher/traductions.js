IE.fModule({
  f: function (exports, require, module, global) {
    ...
    module.exports.trad = function (a) {
      ...
      a('fenetreHarcelement.EstLaPourVous', 'Le %s est là pour vous !');
      a('fenetreHarcelement.LibelleTchatez', 'Tchatez ou appelez le %s');
      a(
      ...
      a(
        ...
        'https://swie.index-education.com/redirect.php?produit=pn&page=comment-renforcer-securite&version=2025.2.11.0&distrib=FR&lg=fr&flag=Espace_Professeur&type=LienDocProduit',
      );
      a(
        'AvertissementDemo',
      ...
      a('fiche.incident.actionsEnvisagees', 'Actions immédiates');
      ...
      a(
        ...
        'Vous avez %s document(s) à signer',
      );
      ...
      a('incidents.heureIncident', "Heure de l'incident");
      ...
      a('incidents.duree', 'Durée');
      a('incidents.accompagnateur', 'Accompagnateur');
      a('incidents.faitDeViolence', 'Fait de violence');
      a('incidents.actionsEnvisagees', 'Actions immédiates');
      a('incidents.suitesDonnees', 'Suites données');
      a('incidents.sansDecision', 'Sans décision');
      a(
        'incidents.hintActionsEnvisagees',
        "Actions immédiates menées par l'établissement",
      );
      a('incidents.hintID', "Identifiant de l'incident");
      ...
      a(
        ...
        "Publier l'incident dans le carnet de correspondance sur l'Espace parents",
      );
      ...
      a(
        'AbsenceVS.obligatoireSelonMotif',
        'Champs obligatoire selon la raison sélectionnée',
      );
      a(
      ...
      a(
        ...
        'Signalez par un double clic les moyennes non représentatives pour le contrôle continu.',
      );
      a(
      ...
      a(
        ...
        "Feuille d'appel jusqu'au",
      );
      a(
        'CarnetCorrespondance.DateDeMiseEnEvidenceHint',
        "Mis en évidence dans la feuille d'appel jusqu'à la date saisie",
      );
      ...
      a(
        'Casier.btnTotalFenetreSelectionCollecte',
      ...
      a('$GlossaireDossierVieScolaire', (b) => {
        ...
        a(
          `${b}.RestreindreVisibiliteDossier`,
          'Restreindre la visibilité du dossier',
        );
        a(
      ...
      a('$GlossaireMediaCentre', (b) => {
        ...
        a(
          `${b}.ConsulterLienExterne`,
          'Consulter le lien de la ressource dans un nouvel onglet',
        );
      });
