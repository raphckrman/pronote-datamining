  ...
  f: function (exports, require, module, global) {
    ...
    module.exports.trad = function (a) {
      ...
      a(
        ...
        'https://www.index-education.com/redirect.php?produit=pn&page=comment-renforcer-securite&version=2025.2.10.0&distrib=FR&lg=fr&flag=Espace_Professeur&type=LienDocProduit',
      );
      a(
        'AvertissementDemo',
      ...
      a(
        ...
        "Seules les moyennes périodiques des services de notation complets (c'est-à-dire ayant une moyenne et une appréciation) sont affichées dans la fiche brevet et prises en compte dans le calcul des moyennes annuelles qui seront exportées vers LSU.",
      );
      a(
