  ...
  f: function (exports, require, module, global) {
    ...
    class ObjetSaisie extends ObjetIdentite_1.Identite {
      ...
      _remplirListe() {
        ...
        let lContainerMaxTop = 0;
        let lContainerMaxBottom = ObjetNavigateur_1.Navigateur.ecranH;
        if (!lEstOuvertureModale) {
          const lRectOverflow = ObjetPosition_1.GPosition.getClientRect(
            ObjetHtml_1.GHtml.getParentOverflowNonVisible(lJBouton.get(0)),
          );
          lContainerMaxTop = Math.max(lContainerMaxTop, lRectOverflow.top);
          lContainerMaxBottom = Math.min(
            lContainerMaxBottom,
            lRectOverflow.bottom,
          );
        }
        ...
        const lHauteurVersBas =
          lContainerMaxBottom - lRectRef.bottom - lCorrectionHauteur;
        const lHauteurVersHaut =
          lRectRef.top - lCorrectionHauteur - lContainerMaxTop;
